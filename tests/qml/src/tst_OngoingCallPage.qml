    ...
    OngoingCallPage {
        ...
        TestCase {
            ...
            function test_checkLocalPreviewAnchoring() {
                ...
                moveAndVerifyState(-uut.previewMargin, uut.previewMarginYBottom + 1, "anchor_bottom_left");
                moveAndVerifyState(uut.previewMargin, uut.previewMarginYBottom + 1, "anchor_bottom_right");
