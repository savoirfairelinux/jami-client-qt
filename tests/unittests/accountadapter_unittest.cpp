...
/*!
 * Test fixture for SensorDataDispatcher testing
 */
...
public:
    ...
    void SetUp() override
    {
        ...
        lrcInstance_.reset(new LRCInstance(nullptr, nullptr, "", connectivityMonitor_.get()));
        lrcInstance_->subscribeToDebugReceived();

        // setup the adapters (their lifetimes are that of MainApplication)
        accountAdapter_.reset(new AccountAdapter(settingsManager_.get(), lrcInstance_.data(), nullptr));
    }
