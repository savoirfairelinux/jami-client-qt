...
class PluginListPreferenceModel : public QAbstractListModel
{
    ...
    Q_PROPERTY(QString preferenceCurrentValue READ preferenceCurrentValue WRITE setPreferenceCurrentValue)
...
public:
    ...
    void setPreferenceCurrentValue(const QString preferenceCurrentValue) { preferenceCurrentValue_ = preferenceCurrentValue; }
    ...
    QString preferenceCurrentValue() { return preferenceCurrentValue_; }
...
private:
    ...
    QString pluginId_ = "";
    QString preferenceCurrentValue_ = "";
