        ...
        try {
            ...
            switch (call.layout) {
                case lrc::api::call::Layout::GRID:
                    callModel->setActiveParticipant(convInfo.confId, convInfo.callId);
                    callModel->setConferenceLayout(convInfo.confId, lrc::api::call::Layout::ONE_WITH_SMALL);
                    break;
                case lrc::api::call::Layout::ONE_WITH_SMALL:
                    callModel->setActiveParticipant(convInfo.confId, convInfo.callId);
                    callModel->setConferenceLayout(convInfo.confId,
        ...
        try {
            ...
            switch (call.layout) {
                case lrc::api::call::Layout::GRID:
                    break;
                case lrc::api::call::Layout::ONE_WITH_SMALL:
                    callModel->setConferenceLayout(convInfo.confId, lrc::api::call::Layout::GRID);
                    break;
                case lrc::api::call::Layout::ONE:
                    callModel->setConferenceLayout(convInfo.confId, lrc::api::call::Layout::ONE_WITH_SMALL);
                    break;
