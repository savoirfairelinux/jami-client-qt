...
public:
    ...
    static QString notificationAccountId;
    static QString notificationConvUid;
...
QString GlobalSystemTray::notificationAccountId = {};
QString GlobalSystemTray::notificationConvUid = {};
