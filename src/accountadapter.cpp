...
void
AccountAdapter::backToWelcomePage(const QString &accountId)
{
    deselectConversation();
    QMetaObject::invokeMethod(qmlObj_, "backToWelcomePage", Q_ARG(QVariant, accountId));
}
