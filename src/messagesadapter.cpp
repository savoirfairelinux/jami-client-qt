...
{
    Q_EMIT setChatViewMode(convInfo["isRequest"].toBool() || convInfo["needsSyncing"].toBool(),
                           !convInfo["isSwarm"].toBool(),
                           convInfo["needsSyncing"].toBool(),
                           convInfo["title"].toString(),
                           convInfo["convId"].toString(),
                           convInfo["readOnly"].toBool());
