...
Item {
    ...
    property string updateFound: qsTr("A version of Jami was found. Would you like to update now?")
    ...
    property string updateDownloadError: qsTr("Installer download failed, please contact support")
