...
- (void) sendNotificationWithId:(NSString*) notificationId title:(NSString*) title body:(NSString*) body avatar:(NSImage*)avatar;
...
//    } else {
        ...
        [notification setContentImage: avatar];
                             ...
                             const QByteArray& avatar)
{
    ...
    if(!avatar.isEmpty())
    {
      ...
      // image = QtMac::toNSImage(p);
    }
    [notificationDelegate sendNotificationWithId: id.toNSString() title:title.toNSString() body: body.toNSString() avatar: image];
}
