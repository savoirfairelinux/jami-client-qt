...
{
    QString currentPreferenceValue = LRCInstance::pluginModel().getPluginPreferencesValues(pluginId_)[preferenceKey_];
    auto resultList = match(index(0, 0), Role::PreferenceEntryValue, QVariant(currentPreferenceValue));
