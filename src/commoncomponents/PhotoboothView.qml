...
ColumnLayout {
    ...
    property bool avatarInternalLoad: false
                ...
                if(!takePhotoState){
                    ...
                    previewWidget.grabToImage(function(result) {
                        ...
                        if (saveToConfig) {
                            ...
                            setAvatarImage(AvatarImage.Mode.FromUrl,
                                           result.url)
                        }
