...
Item {
    ...
    property real xScale: contentRect.width / width
    property real yScale: contentRect.height / height
...
//        // These computations are required to position overlay elements
//        // on the actual render area.
//        function computeInsetRect() {
//            if (!crop) {
//                print(contentRect)
//            }
//        }
//        onSourceRectChanged: computeInsetRect()
//        onFillModeChanged: computeInsetRect()
//        onWidthChanged: computeInsetRect()
//        onHeightChanged: computeInsetRect()
