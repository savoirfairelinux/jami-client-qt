...
Loader {
    ...
    sourceComponent: {
        if (Status === Interaction.Status.TRANSFER_FINISHED) {
            ...
            if (Object.keys(mediaInfo).length !== 0 && USE_WEBENGINE)
                    ...
                    Component {
                        ...
                        Loader {
                            Component.onCompleted: {
                                var qml = USE_WEBENGINE ? "qrc:/src/commoncomponents/MediaPreviewBase.qml" : "qrc:/src/disablewebengine/MediaPreviewBase.qml"
