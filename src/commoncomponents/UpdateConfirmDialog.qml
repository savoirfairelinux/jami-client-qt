...
Dialog {
    ...
    function openWithPara(updateToBeta){
        installType = updateToBeta ? UpdateConfirmDialog.Beta: UpdateConfirmDialog.Release
        ...
        ColumnLayout{
            ...
            ColumnLayout{
                ...
                Label{
                    ...
                    Layout.maximumWidth: contentOfDialog.width - 34
                ...
                RowLayout{
                    ...
                    Label{
                        ...
                        text:switch (installType) {
                             case UpdateConfirmDialog.Beta:
                                 return qsTr("Please be aware that this will uninstall your current Release version.<br>" +
