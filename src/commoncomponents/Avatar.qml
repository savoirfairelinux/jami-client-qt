...
Item {
    ...
    Connections {
        ...
        function onAvatarUidChanged(id) {
            print("onAvatarUidChanged", id, root.imageId)
            // filter this id only
            if (id !== root.imageId)
                return
    ...
    PresenceIndicator {
        ...
        anchors.right: imageLayer.right
        anchors.rightMargin: -1
        anchors.bottom: imageLayer.bottom
        anchors.bottomMargin: -1

        size: imageLayer.width * 0.26
