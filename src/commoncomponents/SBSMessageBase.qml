...
ColumnLayout {
    ...
    property alias innerContentWidth: content.width
    property alias innerContent: content
    property alias bubbleVisible: bubble.visible
    ...
    RowLayout {
        ...
        Layout.preferredHeight: content.height + root.extraHeight
        ...
        Item {
            ...
            Column {
                id: content
                width: parent.width
                // actual content are the children here
            }
            MessageBubble {
                id: bubble
                z:-1
                ...
                height: content.childrenRect.height + (visible ? root.extraHeight : 0)
            }
        }
    }
    Item {
