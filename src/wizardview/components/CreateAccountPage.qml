...
Rectangle {
    ...
    StackLayout {
        ...
        ScrollView {
            ...
            ColumnLayout {
                width: Math.max(createAccountStack.width, implicitWidth)
                height: Math.max(createAccountStack.height, implicitHeight)
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Label {
                        ...
                        Layout.leftMargin: (parent.width - createAccountButton.width) / 2
