...
Rectangle {
    ...
    Connections {
        target: WizardStateMachine

        function onCurrentPageChanged() {
            if (WizardStateMachine.currentPage === WizardStateMachine.WizardViewPages.AccountCreation) {
                var accountCreationOption = WizardStateMachine.accountCreationOption
                if (accountCreationOption ===
                        WizardStateMachine.AccountCreationOption.CreateJamiAccount ||
                        accountCreationOption ===
                        WizardStateMachine.AccountCreationOption.CreateRendezVous) {
                    initializeOnShowUp(accountCreationOption ===
                                       WizardStateMachine.AccountCreationOption.CreateRendezVous)
                    root.showThisPage()
                }
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                MaterialButton {
                    ...
                    color: usernameEdit.nameRegistrationState ===
                           UsernameLineEdit.NameRegistrationState.FREE ?
                    ...
                    onClicked: WizardStateMachine.nextStep()
                }
                ...
                MaterialButton {
                    ...
                    onClicked: {
                        ...
                        Object.assign(JamiQmlUtils.accountCreationInputParaObject,
                                      {isRendezVous : WizardStateMachine.accountCreationOption ===
                                                      WizardStateMachine.AccountCreationOption.CreateRendezVous,
                                       password : passwordEdit.text,
                                       registeredName : usernameEdit.text})
                        WizardStateMachine.accountCreationInfo = JamiQmlUtils.accountCreationInputParaObject
                        WizardStateMachine.nextStep()
                    }
                }
    ...
    PushButton {
        ...
        onClicked: WizardStateMachine.previousStep()
    }
}
