    ...
    Connections {
        ...
        function onMainStepChanged() {
            if (WizardViewStepModel.mainStep === WizardViewStepModel.MainSteps.AccountCreation) {
                var accountCreationOption = WizardViewStepModel.accountCreationOption
        ...
        function onSubStepChanged() {
            createAccountStack.currentIndex = WizardViewStepModel.subStep
        }
    }
