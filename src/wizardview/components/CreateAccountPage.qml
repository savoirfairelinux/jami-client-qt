...
Rectangle {
    ...
    property /*alias*/ var text_usernameEditAlias: null// usernameEdit.text

    property int nameRegistrationUIState: null// WizardView.BLANK

    property /*alias*/ var checkState_signUpCheckboxAlias: null// signUpCheckbox.checked
