...
Rectangle {
    ...
    Connections {
        ...
        function onCurrentPageChanged() {
            if (WizardStateMachine.currentPage === WizardStateMachine.WizardViewPages.Initial)
                root.showThisPage()
        }
    }
    ...
    ColumnLayout {
        ...
        MaterialButton {
            ...
            onClicked: WizardStateMachine.nextStep(
                           WizardStateMachine.AccountCreationOption.ImportFromDevice)
        }
        ...
        MaterialButton {
            ...
            onClicked: WizardStateMachine.nextStep(
                           WizardStateMachine.AccountCreationOption.ImportFromBackup)
        }
        ...
        MaterialButton {
            ...
            onClicked: WizardStateMachine.nextStep(
                           WizardStateMachine.AccountCreationOption.ConnectToAccountManager)
        }
        ...
        MaterialButton {
            ...
            onClicked: WizardStateMachine.nextStep(
                           WizardStateMachine.AccountCreationOption.CreateSipAccount)
        }
