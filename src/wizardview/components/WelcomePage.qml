...
Rectangle {
    ...
    KeyNavigation.down: newAccountButton
    ...
    ColumnLayout {
        ...
        MaterialButton {
            ...
            KeyNavigation.up: backButton.visible ? backButton :
                                                   (showAdvancedButton.showAdvanced ?
                                                        newSIPAccountButton :
                                                        showAdvancedButton)
            KeyNavigation.down: newRdvButton
        ...
        MaterialButton {
            ...
            KeyNavigation.up: newAccountButton
            KeyNavigation.down: fromDeviceButton
        ...
        MaterialButton {
            ...
            KeyNavigation.down: fromBackupButton
        ...
        MaterialButton {
            ...
            KeyNavigation.down: showAdvanced ? connectAccountManagerButton :
                                               (backButton.visible ? backButton : newAccountButton)
        ...
        MaterialButton {
            ...
            KeyNavigation.down: backButton.visible ? backButton : newAccountButton
