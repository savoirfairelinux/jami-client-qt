...
private:
    ...
    void notificationClicked(QSystemTrayIcon::ActivationReason reason = QSystemTrayIcon::Unknown);
    ...
    QMetaObject::Connection notificationActivatedConnection_;
    QMetaObject::Connection notificationClickedConnection_;
