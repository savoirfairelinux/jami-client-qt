...
VideoRenderingItemBase::updatePaintNode(QSGNode* old, UpdatePaintNodeData*)
{
    ...
    qDebug() << pointGlobal.x();

    textureVertices[0].set((((pointGlobal.x() * 2) / window()->width()) - 1),
                           (-(((pointGlobal.y() + height()) * 2) / window()->height()) + 1),
                           0.0f,
                           0.0f,
                           1.0f);
    textureVertices[1].set((((pointGlobal.x() * 2) / window()->width()) - 1),
                           (-((pointGlobal.y() * 2) / window()->height()) + 1),
                           0.0f,
                           0.0f,
                           0.0f);
    textureVertices[2].set(((((pointGlobal.x() + width()) * 2) / window()->width()) - 1),
                           (-((pointGlobal.y() * 2) / window()->height()) + 1),
                           0.0f,
                           1.0f,
                           0.0f);
    textureVertices[3].set(((((pointGlobal.x() + width()) * 2) / window()->width()) - 1),
                           (-((pointGlobal.y() * 2) / window()->height()) + 1),
                           0.0f,
                           1.0f,
                           0.0f);
    textureVertices[4].set(((((pointGlobal.x() + width()) * 2) / window()->width()) - 1),
                           (-(((pointGlobal.y() + height()) * 2) / window()->height()) + 1),
                           0.0f,
                           1.0f,
                           1.0f);
    textureVertices[5].set((((pointGlobal.x() * 2) / window()->width()) - 1),
                           (-(((pointGlobal.y() + height()) * 2) / window()->height()) + 1),
                           0.0f,
                           0.0f,
                           1.0f);
