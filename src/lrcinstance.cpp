...
LRCInstance::selectConversation(const QString& accountId, const QString& convUid)
{
    ...
    auto doSelect = [this, accountId, convUid] {
        set_selectedConvUid(convUid);
    };
    if (accountId != getCurrAccId()) {
        Utils::oneShotConnect(this, &LRCInstance::currentAccountChanged, [doSelect] { doSelect(); });
