...
ItemDelegate {
    ...
    MediaHandlerPreferences{
        id: mediaHandlerPreferences
        pluginId: pluginId
    ...
    RowLayout{
        ...
        Switch {
         ...
         HoverableRadiusButton{
            ...
            onClicked: {
                mediaHandlerPreferences.pluginId = pluginId
                mediaHandlerPreferences.mediaHandlerId = mediaHandlerId
                mediaHandlerPreferences.mediaHandlerName = mediaHandlerName
                mediaHandlerPreferences.open()
            }
        }
    }
}
