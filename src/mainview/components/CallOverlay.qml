...
Item {
    ...
    function updateButtonStatus(isPaused, isAudioOnly, isAudioMuted, isVideoMuted,
        ...
        mainOverlay.buttonGroup.setButtonStatus(isPaused, isAudioOnly,
                                                isAudioMuted, isVideoMuted,
                                                isSIP, isConferenceCall)
    }

    function updateMenu() {
        mainOverlay.buttonGroup.updateMenu()
    }
    ...
    function resetRemoteRecording() {
        ...
        mainOverlay.recordingRect.visible = callViewContextMenu.localIsRecording
    }
