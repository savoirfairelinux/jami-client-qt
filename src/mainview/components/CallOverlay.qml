            ...
            if (participantOverlays[p]) {
                ...
                if (participant) {
                    ...
                    if (participant.videoMuted)
                        participantOverlays[p].setAvatar(true, participant.avatar, participant.uri, participant.isLocal)
                    else
            ...
            for (var infoVariant in infos) {
                ...
                if (!currentUris.includes(infos[infoVariant].uri)) {
                    ...
                    if (infos[infoVariant].videoMuted)
                        hover.setAvatar(true, infos[infoVariant].avatar, infos[infoVariant].uri, infos[infoVariant].isLocal)
                    else
