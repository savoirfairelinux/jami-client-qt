...
Item {
    ...
    function updateUI(isPaused, isAudioOnly, isAudioMuted,
        ...
        root.isPaused = isPaused !== undefined ? isPaused : false
        root.isAudioOnly = isAudioOnly !== undefined ? isAudioOnly : false
        root.isAudioMuted = isAudioMuted !== undefined ? isAudioMuted : false
        root.isVideoMuted = isVideoMuted !== undefined ? isVideoMuted : false
        root.isRecording = isRecording !== undefined ? isRecording : false
        root.isSIP = isSIP !== undefined ? isSIP : false
        root.isModerator = CallAdapter.isCurrentModerator()

        mainOverlay.callActionBar.reset()

        mainOverlay.recordingVisible = isRecording !== undefined ? isRecording : false
    }
