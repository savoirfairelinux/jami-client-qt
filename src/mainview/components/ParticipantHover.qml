    ...
    Row {
        ...
        Rectangle {
            ...
            Button {
                ...
                onClicked: {
                    var mousePos = mapToItem(videoCallPageRect, optionsButton.x, optionsButton.y)
                    participantContextMenu.visibleItems = 1
                    participantContextMenu.showMazimize(true)
                    participantContextMenu.showMinimize(true)
