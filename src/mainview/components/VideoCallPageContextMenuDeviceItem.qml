...
GeneralMenuItem {
    ...
    itemName: textMetrics.elidedText.length !== 0? textMetrics.elidedText : qsTr("No video device")

    indicator: null

    iconSource: videoCallPageContextMenuDeviceItem.checked? "qrc:/images/icons/check_box-24px.svg" : "qrc:/images/icons/check_box_outline_blank-24px.svg"
