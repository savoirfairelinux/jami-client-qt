...
ItemDelegate {
    ...
    // !!! sort animation hack
    onYChanged: z = 70368744177663 - index

    // TODO: this could be better placed outside the delegate
    Connections {
    ...
    background: Rectangle {
        color: {
            ...
            // !!! sort animation hack (should be transparent)
            else if (root.y - Math.floor(root.y) !== 0 &&
