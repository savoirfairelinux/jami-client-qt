        ...
        for (var p in participantOverlays) {
            if (participantOverlays[p]) {
                ...
                if (participant) {
                    ...
                    var newX = participant.x * widthScaleFactor
                    var newY = participant.y * heightScaleFactor
                    var newWidth = participant.w * widthScaleFactor
                    var newHeight = participant.h * heightScaleFactor
            ...
            for (var infoVariant in infos) {
                ...
                if (!currentUris.includes(infos[infoVariant].uri)) {
                    var hover = participantComponent.createObject(distantRenderer, {
                        x: infos[infoVariant].x * widthScaleFactor,
                        y: infos[infoVariant].y * heightScaleFactor,
                        width: infos[infoVariant].w * widthScaleFactor,
                        height: infos[infoVariant].h * heightScaleFactor,
