...
Rectangle {
    ...
    property bool isActive: overlayMenu.isActive
    ...
    function setMenu(isModerator, isHost, newUri, bestName, newIsActive, isLocal,
                     showMax, showMin) {

        overlayMenu.uri = newUri
        overlayMenu.bestName = bestName
        overlayMenu.isActive = newIsActive
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                CallAdapter.maximizeParticipant(uri, isActive)
            }
