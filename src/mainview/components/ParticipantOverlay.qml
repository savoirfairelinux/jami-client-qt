...
Rectangle {
    ...
    property string participantUri: overlayMenu.uri
    property bool participantIsModerator: false
    property bool participantIsMuted: false
    property bool participantIsActive: overlayMenu.active
    ...
    function setMenu(isModerator, isHost, setUri, bestName, active, isLocal, isMaxSize) {
        console.error("isModerator, active, isLocal, isMaxSize")
        console.error(isModerator, active, isLocal, isMaxSize)
        ...
        overlayMenu.showMaximize = isModerator && !isMaxSize
        overlayMenu.showMinimize = isModerator && active
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onClicked: {
                CallAdapter.maximizeParticipant(participantUri, participantIsActive)
            }
