...
Item {
    ...
    function setMenu(newUri, bestName, isLocal, isActive, showMax) {
        ...
        overlayMenu.showModeratorMute = meModerator && !isModeratorMuted
        overlayMenu.showModeratorUnmute = (meModerator || isMe) && isModeratorMuted
    ...
    MouseArea {
        ...
        // - In another participant, if i am not moderator, the mute state is isLocalMuted || isModeratorMuted
