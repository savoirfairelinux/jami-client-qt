...
Rectangle {
    ...
    function setMenu(newUri, bestName, isLocal, showMax, showMin) {
        ...
        console.error("uri: ", overlayMenu.uri,
                      "    name: ", overlayMenu.bestName,
                      "    isLocal:", isLocal,
                      "    localIsHost:", isHost,
                      "    localIsModerator: ", isModerator,
                      "    participantIsHost:", participantIsHost,
                      "    participantIsModerator", participantIsModerator)
