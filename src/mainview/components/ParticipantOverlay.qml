...
Rectangle {
    ...
    .arg(offsetIndicators).arg(shapeHeight-shapeRadius).arg(shapeRadius).
    arg(offsetIndicators-shapeRadius)

    property string pathShapeIndicators: "M0,0 h%1 v%2 h-%3 q-%4,0 -%4,-%4 z".
    arg(offsetIndicators).arg(shapeHeight).arg(offsetIndicators-shapeRadius).
    arg(shapeRadius)
