            ...
            Rectangle {
                ...
                Button {
                    ...
                    onClicked: {
                        ...
                        var isHost = CallAdapter.isCurrentHost(uri)
                        ...
                        injectedContextMenu.showSetModerator = !isHost && !isModerator
                        injectedContextMenu.showUnsetModerator = !isHost && isModerator
