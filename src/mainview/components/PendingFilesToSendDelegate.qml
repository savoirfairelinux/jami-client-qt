...
Rectangle {
    ...
    radius: JamiTheme.pendingFilesToSendDelegateRadius
    ...
    ColumnLayout {
        ...
        Text {
            ...
            font.pointSize: JamiTheme.pendingFilesToSendDelegateFontPointSize
    ...
    PushButton {
        ...
        radius: margin
        preferredSize: JamiTheme.pendingFilesToSendDelegateButtonSize
