...
ListView {
    ...
    width: currentItem ? currentItem.width : JamiTheme.participantCallInStatusViewWidth
    ...
    Connections {
        ...
        function onRowsInserted() {
            ...
            root.height = JamiTheme.participantCallInStatusViewHeight
                    < preferredHeight ? JamiTheme.participantCallInStatusViewHeight : preferredHeight
        }
