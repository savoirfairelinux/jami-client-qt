...
Item {
    ...
    SplitView {
        ...
        Rectangle {
            ...
            property int showable: inLine ? Math.floor((width * 0.6)/commonParticipantsFlow.componentWidth) : commonParticipants.count
                ...
                Flow {
                    ...
                    Repeater {
                        ...
                        delegate: Loader {
                            ...
                            visible: index >= genericParticipantsRect.currentPos && index < genericParticipantsRect.currentPos + genericParticipantsRect.showable 
                            width: {
