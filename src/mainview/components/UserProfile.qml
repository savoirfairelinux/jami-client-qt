...
Window {
    ...
    width: JamiTheme.preferredDialogWidth*1.25
    height: JamiTheme.preferredDialogHeight*1.25
    minimumWidth: JamiTheme.preferredDialogWidth*1.25
    minimumHeight: JamiTheme.preferredDialogHeight*1.25
