...
Rectangle {
    ...
    property int minimumWidth: rowLayoutButtons.width+40

    width: minimumWidth
    height: 114

    color: hasMinimumWidth? "transparent" : JamiTheme.darkGreyColor70
    radius: 10
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            PushButton {
                ...
                source: isMuted? "qrc:/images/icons/mic_off-24px.svg"
