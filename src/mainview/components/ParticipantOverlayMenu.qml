...
Rectangle {
    ...
    width: isBarLayout? bestNameLabel.contentWidth + buttonsSize + 32 : minimumWidth
    height: isBarLayout? 24 : minimumHeight
    ...
    MouseArea {
        ...
        Text {
            ...
            anchors {
                ...
                verticalCenterOffset: isBarLayout? 0 : -16
            }
            TextMetrics {
