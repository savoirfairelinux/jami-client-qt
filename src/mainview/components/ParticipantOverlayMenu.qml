...
Rectangle {
    ...
    property int shapeWidth: bestNameLabel.contentWidth + buttonsSize + 32
    property int shapeHeight: 24
    ...
    property int isSmall: !isBarLayout && (height < 100 || width < 160) // Need to reduce vertical space
    ...
    height: isBarLayout? 24 : (isOverlayRect? 80 : parent.height)
    ...
    MouseArea {
        ...
        Text {
            ...
            anchors {
                ...
                verticalCenterOffset: (isBarLayout || visibleButtons === 0)? 0
                                                                           : (isSmall? -12 : -16)
            }
            TextMetrics {
        ...
        Rectangle {
            ...
            anchors {
                ...
                horizontalCenter: isBarLayout? undefined : parent.horizontalCenter
                verticalCenter: parent.verticalCenter
                verticalCenterOffset: isBarLayout? 0 : (isSmall? 8 : 16)
            }
            ...
            RowLayout {
                ...
                PushButton {
                    ...
                    Rectangle {
                        ...
                        anchors {
                            ...
                            horizontalCenterOffset: isSmall? 16 : 0
                            top: parent.bottom
                            topMargin: isSmall? 0 : 6
                        }
                ...
                PushButton {
                    ...
                    onHoveredChanged: {
                        toggleMuteToolTip.visible = hovered
                    }

                    Rectangle {
                        id: toggleMuteToolTip
                        height: 16
                        width: toggleMuteToolTipText.width + 8
                        anchors {
                            horizontalCenter: parent.horizontalCenter
                            top: parent.bottom
                            topMargin: isSmall? 0 : 6
                        ...
                        Text {
                            ...
                            text: (showModeratorMute? JamiStrings.muteParticipant
                                  ...
                                  + (isLocalMuted? " (" + JamiStrings.localMuted + ")"
                                                 : "")
                            horizontalAlignment: Text.AlignHCenter
                            anchors {
                                horizontalCenter: parent.horizontalCenter
