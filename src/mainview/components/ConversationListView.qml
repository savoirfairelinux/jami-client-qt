...
ListView {
    ...
    Connections {
        ...
        function onValidSelectionChanged() {
            ...
            var uid = model.dataForRow(row, ConversationList.UID)
    ...
    ConversationSmartListContextMenu {
        ...
        function openMenuAt(x, y) {
            ...
            var item = {
                ...
                "displayId": model.dataForRow(row, ConversationList.DisplayID),
                "displayName": model.dataForRow(row, ConversationList.DisplayName),
