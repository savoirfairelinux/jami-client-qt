    ...
    Connections {
        ...
        function onValidSelectionChanged() {
            ...
            ConversationsAdapter.selectConversation(AccountAdapter.currentAccountId,
                                                    convId,
                                                    false)
//            var displayId = model.dataForRow(row, ConversationList.BestId)
//            var displayName = model.dataForRow(row, ConversationList.BestName)
//            var callStackViewShouldShow = model.dataForRow(
//                        row, ConversationList.CallStackViewShouldShow)
//            mainView.setMainView(displayName,
//                                 displayId, uid,
//                                 callStackViewShouldShow,
//                                 model.dataForRow(row, ConversationList.IsAudioOnly),
//                                 model.dataForRow(row, ConversationList.CallState))
            mainView.setMainView(convId)
        }
    }
