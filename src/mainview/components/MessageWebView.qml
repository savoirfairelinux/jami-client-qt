...
//                    onContentYChanged: {
//                        var ypos = chatView.ScrollBar.vertical.position
//                        if (ypos <= 0.15 &&
...
//                    Connections {
//                        target: MessagesAdapter.messageListModel !== undefined ?
//                                    MessagesAdapter.messageListModel :
//                                    null
//                        ignoreUnknownSignals: true
//                        function onRowsInserted(_, first, last) {
//                            print("onRowsInserted", first, last)
//                        }
//                        function onRowsMoved(_, start, end, _, row) {
//                            print("onRowsMoved", start, end, row)
//                        }
//                    }
                    ...
                    Connections {
                        ...
                        function onAllMessagesLoadedChanged() {
                            print("onAllMessagesLoadedChanged")
                        }
                    }
