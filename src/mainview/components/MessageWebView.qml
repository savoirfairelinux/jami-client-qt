...
Rectangle {
    ...
    Connections{
        ...
        function onNewInteraction(interaction_type){
            ...
            MessagesAdapter.beginBuildPreview(1, "hello pls make this work");
        }
...
//                    sourceComponent: regularMessageComponent



//                    Component{
//                        id: regularMessageComponent

//                        RegularMessage{
//                            height: 100
//                            width: 100
//                            sentByMe: sentByMe
//                            timeStampRegularMessage: formattedTimeStamp
//                            regMessageImageId: Author
//                            regularMessageBody: MessageBody
...
//                                    }
                                ...
                                Component.onCompleted: {
                                    if (HyperlinkInformation[0] !== undefined){
                                        console.log("HYperlink Information: " + HyperlinkInformation[0])
                                    }
                                    if (isTextMessage){
                                        if(sentByMe){
