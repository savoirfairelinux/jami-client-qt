...
TabBar {
    ...
    Connections {
        ...
        function onCurrentTypeFilterChanged() {
            var index = ConversationsAdapter.currentTypeFilter ===
                    Profile.Type.PENDING ? 1 : 0
            pageOne.down = (index === SidePanelTabBar.Conversations)
            pageTwo.down = (index === SidePanelTabBar.Requests)
