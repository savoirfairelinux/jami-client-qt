...
Dialog {
    ...
    //contentHeight: aboutPopUpContentRectColumnLayout.height + 5 * 8
    //contentWidth: aboutPopUpContentRectColumnLayout.height + 5 * 8

    visible: false
    title: qsTr("About")

    width: aboutPopUpContentRect.width
    height: aboutPopUpContentRect.height
