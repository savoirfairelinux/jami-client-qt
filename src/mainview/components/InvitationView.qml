...
Rectangle {
    ...
    Text {
        ...
        text: JamiStrings.invitationViewTopPhrase.arg(invitationViewContactTitle)
    }
    ...
    ColumnLayout {
        ...
        Avatar {
            ...
            Layout.topMargin: invitationViewTopPhraseText.visible ? marginSize : 0
        ...
        Text {
            ...
            text: root.invitationViewNeedSyncing ?
                      JamiStrings.invitationViewMiddlePhraseAccepted :
                      JamiStrings.invitationViewMiddlePhraseJoin
        }

        Text {
            id: invitationViewBottomPhraseText
            ...
            text: JamiStrings.invitationViewBottomPhrase.arg(invitationViewContactTitle)
        }
