...
Control {
    ...
    property list<Action> secondaryActions: [
        Action {
            ...
            text: {
                if (!bypassMuteAction)
                    !checked ? JamiStrings.mute : JamiStrings.unmute
                else
                    JamiStrings.selectAudioOutputDevice
            }
        ...
        Action {
            ...
            icon.source: checked ?
                             "qrc:/images/icons/ShareStop_Black_24dp.svg" :
                             "qrc:/images/icons/ShareScreen_Black_24dp.svg"
            icon.color: "white"
