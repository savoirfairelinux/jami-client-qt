...
SpinningAnimation {
    ...
    width: JamiTheme.participantCallInStatusViewWidth + spinningAnimationWidth
    ...
    Rectangle {
        ...
        PushButton {
            ...
            pressedColor: Qt.darker(
                              JamiTheme.participantCallInHangupButtonColor, 1.5)
            hoveredColor: Qt.lighter(
                              JamiTheme.participantCallInHangupButtonColor, 1.5)
