...
Popup {
    ...
    contentItem: StackLayout {
        ...
        Rectangle {
            ...
            width: root.width
            height: childrenRect.height + JamiTheme.pluginHandlersPopupViewDelegateHeight
            ...
            ColumnLayout {
                ...
                height: JamiTheme.pluginHandlersPopupViewHeight + JamiTheme.preferredFieldHeight
