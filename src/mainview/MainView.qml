...
Window {
        ...
        SplitView {
            ...
            Rectangle {
                ...
                StackView {
                    ...
                    width: mainViewSidePanelRect.width
                    height: mainViewSidePanelRect.height - accountComboBox.height
    ...
    LeftPanelView {
        ...
        Connections {
            ...
            function onCheckedToggledForRightPanel(checked) {
                ...
                if (sidePanelHidden) {
                    sidePanelViewStack.push(settingsView)
                }
            }
        }
        Connections {
    ...
    SettingsView {
        ...
        onSettingsViewWindowNeedToShowMainViewWindow: {
            console.error("onSettingsViewWindowNeedToShowMainViewWindow")
        ...
        onSettingsViewWindowNeedToShowNewWizardWindow: {
            console.error("onSettingsViewWindowNeedToShowNewWizardWindow")
            mainViewWindow.noAccountIsAvailable()
        }

        onNavigateToSidePanelSettingsMenu: {
            if (sidePanelHidden)
                sidePanelViewStack.pop(leftPanelSettingsView)
        }
    }
