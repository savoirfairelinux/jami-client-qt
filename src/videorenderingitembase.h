...
public:
    ...
    enum class TexturePlane { Y, U, V, NV12 };
...
private:
    ...
    void initializeTextureDataYUV(QOpenGLTexture* texture);
    void initializeTextureDataNV12(QOpenGLTexture* texture);

    void processAllTexturesData();
    void processTextureDataYUV(QOpenGLTexture* texture, TexturePlane plane);
    void processTextureDataNV12();
    ...
    QMap<TexturePlane, QOpenGLPixelTransferOptions> options_;
