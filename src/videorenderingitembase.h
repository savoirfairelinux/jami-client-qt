...
private:
    ...
    void processTextureDataYUV(QOpenGLTexture* texture, int width, int height, uint8_t* data);
    void processTextureDataNV12(QOpenGLTexture* texture, int width, int height, uint8_t* data);
