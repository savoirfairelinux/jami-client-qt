...
protected:
    ...
    Q_INVOKABLE void beginBuildPreview(int messageId, QString url);
    ...
    void sendPreviewInfo(int messageIndex, QVariantList urlInMessage);
...
Q_SIGNALS:
    ...
    void previewInformationToQML(int messageId, QVariantList previewInformation);
