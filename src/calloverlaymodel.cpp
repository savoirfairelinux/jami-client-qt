...
PendingConferenceesListModel::data(const QModelIndex& index, int role) const
{
    ...
    try {
        ...
        pendingConferenceeCallId = currentPendingConferenceeInfo.pendingConferenceeCallId;
        const auto call = callModel->getCall(pendingConferenceeCallId);

        callStatus = call.status;
        pendingConferenceeContactUri = currentPendingConferenceeInfo.pendingConferenceeUri;
