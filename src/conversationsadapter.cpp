...
#ifdef Q_OS_LINUX
        auto contactPhoto = Utils::contactPhoto(lrcInstance_, interaction.authorUri, QSize(50, 50));
...
ConversationsAdapter::onNewTrustRequest(const QString& accountId, const QString& peerUri)
{
    ...
    if (!QApplication::focusWindow() || accountId != lrcInstance_->getCurrAccId()) {
        ...
        auto contactPhoto = Utils::contactPhoto(lrcInstance_, peerUri, QSize(50, 50));
