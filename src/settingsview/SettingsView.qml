...
Rectangle {
    ...
    signal navigateToSidePanelSettingsMenu
    ...
    Component.onCompleted: {
        currentAccountSettingsScrollWidget.navigateToSidePanelMenu.connect(navigateToSidePanelSettingsMenu)
        currentSIPAccountSettingsScrollWidget.navigateToSidePanelMenu.connect(navigateToSidePanelSettingsMenu)
        generalSettings.navigateToSidePanelMenu.connect(navigateToSidePanelSettingsMenu)
        avSettings.navigateToSidePanelMenu.connect(navigateToSidePanelSettingsMenu)
        pluginSettings.navigateToSidePanelMenu.connect(navigateToSidePanelSettingsMenu)
    }
}
