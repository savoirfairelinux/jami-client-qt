...
Rectangle {
    ...
    Layout.maximumWidth: maximumWidthSettingsView
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            HoverableButton {
                ...
                Layout.preferredWidth: preferredFieldHeight
                Layout.preferredHeight: preferredFieldHeight
                Layout.rightMargin: preferredMarginSize
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                ToggleSwitch {
                    ...
                    Layout.topMargin: preferredMarginSize
                    Layout.leftMargin: preferredMarginSize
                ...
                ColumnLayout {
                    ...
                    MaterialLineEdit {
                        ...
                        Layout.maximumWidth: preferredButtonWidth
                        Layout.minimumHeight: preferredFieldHeight
                        Layout.preferredHeight: preferredFieldHeight
                        Layout.maximumHeight: preferredFieldHeight
                    ...
                    RowLayout {
                        ...
                        TextField {
                            ...
                            TextMetrics {
                                ...
                                elideWidth: accountViewRect.width - idLabel.width - preferredMarginSize*3
                ...
                RowLayout {
                    ...
                    MaterialButton {
                        ...
                        Layout.minimumWidth: accountViewRect.width / 3 - parent.spacing
                        Layout.preferredWidth: accountViewRect.width / 3 - parent.spacing
                        Layout.minimumHeight: preferredFieldHeight
                        Layout.preferredHeight: preferredFieldHeight
                        Layout.maximumHeight: preferredFieldHeight
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ElidedTextLabel {
                            ...
                            fontSize: JamiTheme.headerFontSize
                            maxWidth: accountViewRect.width - bannedContactsBtn.width - preferredMarginSize*4
                        }
                        ...
                        HoverableButtonTextItem {
                            ...
                            Layout.maximumWidth: preferredFieldHeight
                            Layout.preferredWidth: preferredFieldHeight
                            Layout.minimumWidth: preferredFieldHeight
                ...
                RowLayout {
                    ...
                    ElidedTextLabel {
                        ...
                        fontSize: JamiTheme.headerFontSize
                        maxWidth: accountViewRect.width - advancedAccountSettingsPButton.width - preferredMarginSize*4
                    }
