...
ItemDelegate {
    ...
    signal btnRemoveModeratorClicked
    ...
    RowLayout {
        ...
        PushButton{
            ...
            source: "qrc:/images/icons/round-remove_circle-24px.svg"
            imageColor: JamiTheme.textColor
            normalColor: highlighted? JamiTheme.selectedColor : JamiTheme.editBackgroundColor

            //toolTipText: //Albert canviarJamiStrings.reinstateContact

            onClicked: btnRemoveModeratorClicked()
        }
    }
}
