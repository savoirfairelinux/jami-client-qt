...
ColumnLayout {
    ...
    function decreaseAudioCodecPriority(){
        ...
        var codecId = audioListWidget.model.data(audioListWidget.model.index(index,0), audioListWidget.model.AudioCodecID)
    ...
    function decreaseVideoCodecPriority(){
        ...
        var codecId = videoListWidget.model.data(videoListWidget.model.index(index,0), videoListWidget.model.VideoCodecID)
