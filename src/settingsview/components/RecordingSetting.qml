...
ColumnLayout {
    ...
    Timer{
        ...
        onTriggered: ClientWrapper.avmodel.setRecordQuality(recordQualitySlider.value * 100)
    }
    ...
    ToggleSwitch {
        ...
        checked: ClientWrapper.avmodel.getAlwaysRecord()

        labelText: qsTr("Always record calls")
        fontPointSize: JamiTheme.settingsFontSize

        onSwitchToggled: ClientWrapper.avmodel.setAlwaysRecord(checked)
    }
    ...
    ToggleSwitch {
        ...
        checked: ClientWrapper.avmodel.getRecordPreview()

        labelText: qsTr("Record preview video for a call")
        fontPointSize: JamiTheme.settingsFontSize

        onSwitchToggled: ClientWrapper.avmodel.setRecordPreview(checked)
    }
    ...
    RowLayout {
        ...
        Text {
            ...
            text: ClientWrapper.utilsAdaptor.getRecordQualityString(ClientWrapper.avmodel.getRecordQuality() / 100)
        ...
        Slider {
            ...
            Layout.maximumWidth: itensWidth
            Layout.alignment: Qt.AlignRight
            Layout.fillWidth: true
            Layout.fillHeight: true

            value: ClientWrapper.avmodel.getRecordQuality() / 100
