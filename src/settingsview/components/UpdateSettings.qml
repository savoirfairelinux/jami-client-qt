...
ColumnLayout {
    ...
    MaterialButton {
        ...
        onClicked: UtilsAdapter.checkForUpdates(true)
    }
    ...
    MaterialButton {
        ...
        onClicked: UtilsAdapter.applyUpdates(true)
    }
    ...
    Connections {
        ...
        function onUpdateDownloadErrorOccurred() {
            updateIssueDialog.openWithParameters(JamiStrings.updateDialogTitle,
                                                 JamiStrings.updateDownloadError)
        }
    }
    ...
    SimpleMessageDialog {
        ...
        buttonCallBacks: [function() {UtilsAdapter.applyUpdates(false)}]
    }
