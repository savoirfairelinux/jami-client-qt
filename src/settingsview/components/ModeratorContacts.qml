...
ColumnLayout {
    ...
    Connections {
        ...
        function onDefaultModeratorsUpdated() {
            console.error("onDefaultModeratorsUpdated")
            updateAndShowModeratorsSlot()
        }
    }
    ...
    ToggleSwitch {
        ...
        checked: SettingsAdapter.isLocalModeratorsEnabled(AccountAdapter.currentAccountId)

        labelText: qsTr("Enable local moderators")
