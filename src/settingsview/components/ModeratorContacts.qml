...
ColumnLayout {
    ...
    function updateAndShowModeratorsSlot() {
        console.error("updateAndShowModeratorsSlot")
    ...
    function removeModerator(index) {
        ...
        SettingsAdapter.removeDefaultModerator(index)
    }
    ...
    MaterialButton {
        ...
        onClicked: {
            ContactPickerCreation.createContactPickerObjects(
                        ContactPicker.ContactPickerType.ADDMODERATOR,
                        root)
