...
public:
    ...
    Q_INVOKABLE void linkifyReady(const QString& messageId, const QString& linkified, bool hasUrl);
...
Q_SIGNALS:
    ...
    void linkifyReady(const QString& messageId, const QString& linkified, bool hasUrl);
