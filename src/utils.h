...
QImage contactPhotoFromBase64ByteArray(const QByteArray& data, const QString& type);
QImage contactPhoto(const QString& contactUri, const QSize& requestedSize = defaultAvatarSize);
