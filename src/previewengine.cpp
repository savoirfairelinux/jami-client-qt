    ...
    , pimpl_(new PreviewEnginePrivate(this))
{
    ...
    page()->runJavaScript(Utils::QByteArrayFromFile(":/linkify.js"),
...
void
PreviewEngine::linkifyMessage(QString messageId, QString message)
{
    page()->runJavaScript(QString("parseMessage(`%1`, `%2`)").arg(messageId, message));
}
...
void
PreviewEnginePrivate::messageLinkifyReady(QString messageId, QString linkifiedMessage, bool urlPresent)
{
    Q_EMIT parent_->messageLinkified(messageId, linkifiedMessage, urlPresent);
}
