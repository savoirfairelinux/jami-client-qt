...
public:
    enum MessageRoles { IdRole = Qt::UserRole + 1, BodyRole, TypeRole, SenderRole, TimestampRole };
...
private Q_SLOTS:
    void onSwarmLoaded(uint32_t requestId,
                       const QString& accountId,
                       const QString& conversationId,
                       const VectorSwarmMessage& messages);
    void onConversationLoaded(uint32_t requestId,
                              const QString& accountId,
                              const QString& conversationId,
