    ...
    : QAbstractListModel(parent)
{
    ...
    connect(&CoreService::instance(), &CoreService::accountsChanged, this, &AccountListModel::onAccountsChanged);

    // Connect to initialization to trigger first load
    connect(&CoreService::instance(), &CoreService::initializationChanged, this, &AccountListModel::reload);
...
void
AccountListModel::onAccountsChanged()
{
