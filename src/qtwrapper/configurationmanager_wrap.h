...
public:
    ...
    ConfigurationManagerInterface()
    {
        ...
        confHandlers = {
            ...
            exportable_callback<ConfigurationSignal::CollaborativeDocumentChanged>([this](const std::string& account_id,
            ...
            exportable_callback<ConfigurationSignal::CollaborativeCursorChanged>([this](const std::string& account_id,
                                                                                        const std::string& convId,
                                                                                        const std::string& documentId,
            ...
            exportable_callback<ConfigurationSignal::CollaborativeDocumentDelta>([this](const std::string& account_id,
                                                                                        const std::string& convId,
                                                                                        const std::string& documentId,
...
public Q_SLOTS: // METHODS
    ...
    {
        return QString::fromStdString(libjami::collaborativeDocumentTextAt(accountId.toStdString(),
                                                                           conversationId.toStdString(),
                                                                           documentId.toStdString(),
    ...
    void setCollaborativeCursor(
        const QString& accountId, const QString& conversationId, const QString& documentId, int position, int anchor)
    {
    ...
    QString collaborativeDocumentContentDelta(const QString& accountId,
                                              ...
                                              const QString& documentId)
    {
        return QString::fromStdString(libjami::collaborativeDocumentContentDelta(accountId.toStdString(),
                                                                                 conversationId.toStdString(),
                                                                                 documentId.toStdString()));
    }
