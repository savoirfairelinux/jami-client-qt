...
ContactModel::bestNameForContact(const QString& contactUri) const
{
    ...
    try {
        ...
        if (itContact != pimpl_->nonContactLookup_.end()) {
            ...
            // of time (less than a second), and can easily get called dozens of even hundreds
            // of time in total after using Jami for a couple of hours. We don't want to send
