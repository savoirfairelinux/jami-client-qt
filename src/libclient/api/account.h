...
getLinkDeviceString(DeviceLinkError error)
{
    ...
    case DeviceLinkError::WRONG_PASSWORD:
        return QObject::tr(
            "An authentication error occurred. Please check credentials and try again.");
    case DeviceLinkError::NETWORK:
        return QObject::tr("A network error occurred. Please verify your connection and try again.");
    case DeviceLinkError::TIMEOUT:
        return QObject::tr("The operation has timed out. Please try again.");
    ...
    default:
        return QObject::tr("An unexpected error occurred. Please try again.");
    }
}
