...
public:
    ...
    /**
     * Get active WebView handlers
     * @return List of handler addresses (as strings)
     */
    VectorString getWebViewHandlers() const;

    plugin::PluginHandlerDetails getWebViewHandlerDetails(const QString& handlerAddress);
    ...
    Q_INVOKABLE void sendWebViewDetach(const QString& pluginId,
                                       const QString& accountId,
                                       const QString& webViewId);
