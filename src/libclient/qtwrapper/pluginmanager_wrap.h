...
public:
    ...
    PluginManagerInterface()
    {
        ...
        setObjectName("PluginManagerInterface");
        callbackHandlers = {
            exportable_callback<DRing::WebViewMessageReceived>([this](const std::string& pluginId,
...
public Q_SLOTS: // METHODS
    ...
    MapStringString getWebViewHandlerDetails(const QString& handlerAddress);

    QStringList getWebViewHandlers();
    ...
    void sendWebViewDetach(const QString& pluginId,
                           const QString& accountId,
                           const QString& webViewId);
