...
public Q_SLOTS: // METHODS
    ...
    bool provideAccountAuthentication(const QString& accountId, const QString& credentialsFromUser, const std::string_view scheme)
    {
        // return libjami::provideAccountAuthentication(accountId.toStdString(), credentialsFromUser.toStdString(), scheme);
    }
...
Q_SIGNALS: // SIGNALS
    ...
    // void deviceAuthStateChanged(const QString& accountId, int status, const QString& detail);
