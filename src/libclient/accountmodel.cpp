...
void
AccountModel::provideAccountAuthentication(const QString& accountId, const QString& credentialsFromUser) {
    auto scheme = std::string_view("password");
    ConfigurationManager::instance().provideAccountAuthentication(accountId, credentialsFromUser, scheme);
}
