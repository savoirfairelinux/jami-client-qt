...
{
    qWarning() << "[LinkDevice] accountmodel.cpp: provideAccountAuthentication";
    qWarning() << "[LinkDevice] accountmodel.cpp: pw = " << credentialsFromUser;
...
AccountModel::startLinkDevice()
{
    ...
    return ConfigurationManager::instance().addAccount(details);
}
