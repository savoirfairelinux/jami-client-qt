...
public Q_SLOTS:
     ...
     */
    // void deviceAuthStateChanged(const std::string& account_id, int state, const std::string& detail);
    void slotDeviceAuthStateChanged(const QString& accountId, int state, const QString& detail);
    // void slotDeviceAuthStateChanged(const std::string& account_id, int state, const std::string& detail);
