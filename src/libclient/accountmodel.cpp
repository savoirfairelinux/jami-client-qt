...
account::Info::fromDetails(const MapStringString& details)
{
    ...
    confProperties.denyNewCallsAutoAnswer = toBool(details[ConfProperties::DENYNEWCALLSAUTOANSWER]);
...
account::ConfProperties_t::toDetails() const
{
    ...
    details[ConfProperties::DENYNEWCALLSAUTOANSWER] = toQString(this->denyNewCallsAutoAnswer);
