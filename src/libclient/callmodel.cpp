                       ...
                       bool shareAudio)
{
    ...
    // Only add screenshare audio in 1:1 calls, not in conferences (conference audio negotiation not yet implemented)
    if (!audioMediaAttribute.isEmpty() && !(type == MediaRequestType::SCREENSHARING && isConf))
