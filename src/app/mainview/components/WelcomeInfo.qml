...
Item {
    ...
    property string title: viewNode.title
    property string description: viewNode.description

    property real contentWidth: slimDisplay ? (width - 3 * JamiTheme.mainViewMargin) / 2 : width - 2 * JamiTheme.mainViewMargin

    property bool slimDisplay: false
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            ColumnLayout {
                id: columnLayoutInfo
                Layout.rightMargin: slimDisplay ? JamiTheme.mainViewMargin : 0
                spacing: 0
                ...
                Loader {
                    ...
                    active: !welcomeInfo.slimDisplay
