            ...
            ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            TextEdit {
                                ...
                                Layout.margins: 10
                                Layout.topMargin: 0
                                Layout.maximumWidth: JamiTheme.secondaryDialogDimension - 2*JamiTheme.preferredMarginSize
                ...
                TextEdit {
                    ...
                    TextMetrics {
                        ...
                        text: JamiStrings.declaration + '<a href="https://jami.net" style="color: ' + JamiTheme.blueLinkColor + '">jami.net</a>' + "."
                    }
                ...
                TextEdit {
                    ...
                    TextMetrics {
                        id: textMetricsYears
                        font: jamiDeclarationHyperText.font
                        text: JamiStrings.declarationYear + " " + '<a href="https://savoirfairelinux.com" style="color: ' + JamiTheme.blueLinkColor + '">Savoir-faire Linux</a><br>'
                    }
                ...
                Rectangle {
                    ...
                    ProjectCreditsScrollView {
                        ...
                        anchors.centerIn: parent
                        width: JamiTheme.secondaryDialogDimension - 2*JamiTheme.preferredMarginSize
                        height: 140
                        anchors.margins: 10
                    }
                }
