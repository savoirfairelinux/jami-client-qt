    ...
    buttonsModel: [
        {
            ...
            onClicked: function() { Qt.openUrlExternally("https://jami.net/donate/") }
        },
        {
            text: JamiStrings.contribute,
            onClicked: function() { Qt.openUrlExternally("https://jami.net/contribute/") }
        },
        {
            text: JamiStrings.feedback,
            onClicked: function() { Qt.openUrlExternally("mailto:jami@gnu.org") }
        }
    ]
