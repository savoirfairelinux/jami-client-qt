...
ContextMenuAutoLoader {
    ...
    property bool isJoinedCall: false
    ...
    property list<GeneralMenuItem> menuItems: [
        GeneralMenuItem {
            ...
            canTrigger: CurrentAccount.videoEnabled_Video && !readOnly && !isJoinedCall
            ...
            onClicked: {
                ...
                if (hasActiveCall) {
                    var calls = CurrentConversation.activeCalls;
        ...
        GeneralMenuItem {
            ...
            canTrigger: !readOnly && !isJoinedCall
