                        ...
                        Row {
                            ...
                            ListView {
                                ...
                                delegate: PushButton {
                                    ...
                                    normalColor: modelData.normalColor != null ? modelData.normalColor : "transparent"
                                    imageColor: hovered ? JamiTheme.chatViewFooterImgColor : (modelData.imageColor != null ? modelData.imageColor : "#7f7f7f")
                                    hoveredColor: JamiTheme.showMoreButtonOpenColor
                                    pressedColor: hoveredColor
