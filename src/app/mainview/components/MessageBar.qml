...
Rectangle {
    ...
    RowLayout {
        ...
        onHeightChanged: {
            ...
            anchors.fill = Qt.binding(() => parent);
        }
        ...
        ComboBox {
            ...
            onYChanged: console.log("Changed y : ", y)
        ...
        Rectangle {
            ...
            onWidthChanged: {
                console.log("Le rectangle a change de taille", height, root.height);
                ...
                Row {
                    ...
                    Row {
                        ...
                        PushButton {
                            ...
                            normalColor: showTypo ? JamiTheme.chatViewFooterListColor : "transparent"
                            imageColor: JamiTheme.chatViewFooterImgColor
