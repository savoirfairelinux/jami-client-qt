...
Rectangle {
    ...
    //height: messageRow.preferredHeight + formatRow.height + fileContainer.height + 2*marginSize 
    //Layout.preferredHeight : messageRow.preferredHeight + formatRow.height + fileContainer.height + 2*marginSize
    ...
    ColumnLayout {
        ...
        anchors { 
            ...
            right: parent.right
            top: parent.top
            margins: marginSize/2
        }
        spacing: marginSize/3
        ...
        Rectangle {
            ...
            Layout.preferredHeight: Math.max(messageBarTextArea.textAreaObj.contentHeight,36)
            ...
            MessageBarTextArea {
                ...
                Layout.preferredWidth: parent.width - JamiTheme.chatViewFooterButtonSize - marginSize /2 
