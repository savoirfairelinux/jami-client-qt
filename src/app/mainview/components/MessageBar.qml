...
ColumnLayout {
    ...
    property bool showTypoSecond: true
    property bool showMoreTypo: false
    ...
    onShowTypoSecondChanged: {
        if (showTypoSecond) {
            if (showMoreTypo) {
                showMoreTypo = false
                viewCoordinator.dismiss("commoncomponents/MarkdownPopup.qml")
    ...
    Item {
        ...
        onWidthChanged: {
            if (width < messageBarRowLayout.width) {
            ...
            Row {
                ...
                Row {
                    ...
                    Rectangle {
                        width: 2
                        height: JamiTheme.chatViewFooterButtonSize
                        color: JamiTheme.chatViewFooterShowMoreButtonColor//"#b2cce0"
                    ...
                    Rectangle {
                        ...
                        PushButton {
                            ...
                            onClicked : {
                                showMoreTypo = !showMoreTypo
                                if(showMoreTypo) {
                                    viewCoordinator.presentDialog(
                                               parent,
                                               "commoncomponents/MarkdownPopup.qml",
