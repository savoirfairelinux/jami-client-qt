...
Control {
    ...
    contentItem: RowLayout {
        ...
        NewIconButton {
            ...
            visible: !viewCoordinator.isInSinglePaneMode && (!convContext.inCall || CallPipWindowManager.isPipActive)
        ...
        Button {
            ...
            onClicked: CallPipWindowManager.isPipActive ? CallPipWindowManager.reabsorb() : root.backClicked()
        }
