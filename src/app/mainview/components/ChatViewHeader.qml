...
Control {
    ...
    contentItem: RowLayout {
        ...
        anchors.fill: parent
        // QWK: spacing — layoutManager is only defined in the main window
        anchors.leftMargin: (typeof layoutManager !== "undefined") ? layoutManager.qwkSystemButtonSpacing.left : 0
        anchors.rightMargin: 10 + ((typeof layoutManager !== "undefined") ? layoutManager.qwkSystemButtonSpacing.right : 0)
        spacing: 8
