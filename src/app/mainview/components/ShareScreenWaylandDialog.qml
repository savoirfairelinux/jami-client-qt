...
BaseModalDialog {
    ...
    titleText: JamiStrings.shareScreenWaylandDialogTitle

    closeButtonVisible: false

    button1.text: JamiStrings.share
    ...
    onClosed: {
        if (!cancelDialog) {
            if (root.selectionType === 1) {
                AvAdapter.shareEntireScreenWayland(AvAdapter.muteScreenshareAudio)
            }
            else if (root.selectionType === 2) {
                AvAdapter.shareWindowWayland(AvAdapter.muteScreenshareAudio)
            }
        }
    }
    ...
    popupContent: Column {
        Row {
            ...
            Control {
                ...
                contentItem: ColumnLayout {
                    spacing: 8
                    Text {
                        text: JamiStrings.shareScreenWaylandDialogEntireScreenOption
            ...
            Control {
                ...
                contentItem: ColumnLayout {
                    spacing: 8
                    Text {
                        text: JamiStrings.shareScreenWaylandDialogWindowOption
                        color: JamiTheme.textColor
                        horizontalAlignment: Text.AlignHCenter
                    }
                    IconImage {
        ...
        Text {
            ...
            text: JamiStrings.shareScreenWaylandDialogDesktopAudioInfo
            horizontalAlignment: Text.AlignHCenter
            color: JamiTheme.textColor
