...
JamiFlickable {
    ...
    onSpellLangChanged: {
        onSpellSettingChanged();
    }
    onEnableSpellCheckChanged: {
        onSpellSettingChanged();
    }
    function onSpellSettingChanged() {
        console.info("Spell check settings changed, updating text area");
        ...
        console.info("Spell check active: " + spellCheckActive);
