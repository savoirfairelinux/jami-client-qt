...
Control {
    ...
    property list<Action> secondaryActions: [
        ...
        Action {
            ...
            enabled: CurrentCall.isModerator && LRCInstance.currentAccountType !== Profile.Type.SIP
        ...
        Action {
            ...
            enabled: LRCInstance.currentAccountType === Profile.Type.SIP
        ...
        Action {
            ...
            enabled: CurrentAccount.videoEnabled_Video && LRCInstance.currentAccountType !== Profile.Type.SIP
