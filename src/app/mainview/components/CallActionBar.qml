        ...
        Action {
            ...
            onTriggered: {
                ...
                if (CurrentCall.isSharing) {
                    ...
                    // Audio sharing is not yet implemented for macOS and conferences
                    if (AvAdapter.isSharingScreenOrWindow() && Qt.platform.os.toString() !== "osx" && !CurrentCall.isConference) {
