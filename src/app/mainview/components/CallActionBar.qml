...
Control {
    ...
    property list<Action> primaryActions: [
        ...
        Action {
            ...
            onEnabledChanged: CallOverlayModel.setEnabled(muteVideoAction, muteVideoAction.enabled)
        }
    ]
    ...
    property list<Action> secondaryActions: [
        ...
        Action {
            ...
            onEnabledChanged: CallOverlayModel.setEnabled(addPersonAction, addPersonAction.enabled)
        },
        Action {
            id: chatAction
        ...
        Action {
            ...
            onEnabledChanged: CallOverlayModel.setEnabled(resumePauseCallAction, resumePauseCallAction.enabled)
        },
        Action {
            ...
            enabled: CurrentCall.isSIP
            onEnabledChanged: CallOverlayModel.setEnabled(inputPanelSIPAction, inputPanelSIPAction.enabled)
        },
        Action {
            ...
            enabled: CurrentCall.isSIP
            onEnabledChanged: CallOverlayModel.setEnabled(callTransferAction, callTransferAction.enabled)
        },
        Action {
            id: shareAction
            onTriggered: {
            ...
            onEnabledChanged: CallOverlayModel.setEnabled(shareAction, shareAction.enabled)
        },
        Action {
            id: raiseHandAction
            ...
            onEnabledChanged: CallOverlayModel.setEnabled(raiseHandAction, raiseHandAction.enabled)
        },
        Action {
            id: layoutAction
            onTriggered: {
        ...
        Action {
            ...
            onEnabledChanged: CallOverlayModel.setEnabled(pluginsAction, pluginsAction.enabled)
        },
        Action {
            ...
            onEnabledChanged: CallOverlayModel.setEnabled(swarmDetailsAction, swarmDetailsAction.enabled)
        }
    ]
        ...
        RowLayout {
            ...
            ListView {
                ...
                property int overflowIndex: {
                    ...
                    return CallOverlayModel.getTrueIndex(idx);
                }
