...
Rectangle {
    ...
    Text {
        id: activeCallsText
        text: CurrentConversation.activeCalls.length > 0 
            ?  CurrentConversation.activeCalls.length 
            : qsTr("")
        ...
        Canvas {
            ...
            onPaint: {
                ...
                const gradient = ctx.createLinearGradient(
                    width / 2 + outerRadius * Math.cos(startAngle),
                    height / 2 + outerRadius * Math.sin(startAngle),
                    width / 2 + outerRadius * Math.cos(endAngle),
                    height / 2 + outerRadius * Math.sin(endAngle)
                );
