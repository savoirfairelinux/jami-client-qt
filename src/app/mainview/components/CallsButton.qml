                    ...
                    RowLayout {
                        ...
                        JamiPushButton {
                            ...
                            onClicked: {
                                ...
                                onClicked: MessagesAdapter.joinCall(modelData.uri, modelData.device, CurrentConversation.confId, false);
                                // need to swithc between audio and video
                                // Moreover, when multicall, we need to change the confid depending on the conference object and not rely on the currentconv.
                            }
                        }
                    }
