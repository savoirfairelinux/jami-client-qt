...
Rectangle {
    ...
    onWidthChanged: {
        if (chatViewContainer.visible && root.width < JamiTheme.mainViewRightPaneMinWidth * 2) {
    ...
    SplitView {
        ...
        Item {
            ...
            SplitView.preferredWidth: mainColumnLayout.isHorizontal ?
                                          JamiTheme.mainViewRightPaneMinWidth :
                                          root.width
            SplitView.minimumWidth: JamiTheme.mainViewRightPaneMinWidth
            visible: false
            clip: true
            ...
            onVisibleChanged: {
                if (visible && root.width < JamiTheme.mainViewRightPaneMinWidth * 2) {
                    callPageMainRect.visible = false
                } else {
                    callPageMainRect.visible = true
                }
