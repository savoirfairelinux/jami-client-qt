            ...
            delegate: ItemDelegate {
                ...
                contentItem: RowLayout {
                    ...
                    IconImage {
                        ...
                        source: JamiResources.language_24dp_svg
                    ...
                    NewIconButton {
                        ...
                        onClicked: {
                            ...
                            if (tunnel)
                                ExposedServicesAdapter.closeServiceTunnel(root.accountId, tunnel.tunnelId);//root.openOrCopy(serviceDelegate.modelData)
                        }
                    }
                }
