...
//                SplitView.preferredWidth: JamiTheme.detailsPageMinWidth
                ...
                SwarmDetailsPanel { id: swarmDetailsPanel }
                AddMemberPanel { id: addMemberPanel }
                MessagesResearchPanel { id: messagesResearchPanel }
            }
        }
    }
}
