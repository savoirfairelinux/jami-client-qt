...
Rectangle {
    ...
    function instanceMapObject() {
        if (WITH_WEBENGINE) {
            ...
            var object = component.createObject(realChatContent, {
                                                   boundingItem: chatContents
                                               })
    ...
    ListModel {
        ...
        function updateList(){
            ...
            if(PositionManager.isPositionSharedToConv(accountId, CurrentConversation.id)){
                listUriShare.append({"uri":CurrentAccount.uri});
                localSharing = true
            }

            if(PositionManager.isConvSharingPosition(accountId, CurrentConversation.id)){
                sharing = true
            }
        ...
        SplitView {
            ...
            ColumnLayout {
                    ...
                    ListView {
                        ...
                        Layout.fillWidth: true
                        model: listUriShared
                        delegate: LocationArea {imSharing: false}
                    ...
                    ListView {
                        ...
                        Layout.fillWidth: true
                        model: listUriShare
                        delegate: LocationArea {imSharing: true}
