    ...
    ColumnLayout {
        ...
        JamiSplitView {
            ...
            onExtrasPanelWidthChanged: {
                resolvePanes();
                // This range ensures that the panel won't be stuck maximized.
            ...
            property bool extrasPanelVisible: extrasPanel.visible
            onExtrasPanelVisibleChanged: resolvePanes()
            ...
            function resolvePanes(force = false) {
                ...
                if (width < JamiTheme.mainViewPaneMinWidth + extrasPanelWidth && (!isExpanding || force) && chatContents.visible) {
                    chatContents.visible = false;
                } else if (width >= JamiTheme.mainViewPaneMinWidth + previousExtrasPanelWidth && (isExpanding || force) && !chatContents.visible) {
                    chatContents.visible = true;
                }
            }
