        ...
        ColumnLayout {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Layout.topMargin: {
                            ...
                            const macPadding = JamiTheme.sidePanelSearchBarPaddingMac;
                ...
                Rectangle {
                    ...
                    anchors.topMargin: header.height + JamiTheme.sidePanelConversationsIslandTopPadding + 10 + sidePanelTabBar.height// + JamiTheme.sidePanelIslandsSinglePaneModePadding * 3
