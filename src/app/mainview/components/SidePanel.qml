...
SidePanelBase {
    ...
    property bool searchResultsEmpty: searchResultsListView.model.count === 0
    property bool conversationListEmpty: conversationListView.model.count === 0
    property bool addToSwarmListEmpty: swarmCurrentConversationList.model.count === 0
