...
BaseModalDialog {
    ...
    button1.text: JamiStrings.chooseDevice
    button1.toolTipText: JamiStrings.chooseThisDevice
    button1.enabled: false

    button2.text: JamiStrings.removeThisDevice
    button2.toolTipText: JamiStrings.removeCurrentDevice
    button2.enabled: CurrentConversation.rdvAccount === "" ? false : true
                        ...
                        onClicked: {
                            if (!highlighted){
                                ...
                                root.button1Clicked = function() {
                                    ...
                                    CurrentConversation.setInfo("rdvDevice", deviceId);
                                    root.close();
                                }
                            }
                            else {
