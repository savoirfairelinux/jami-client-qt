...
Item {
    ...
    Image {
        ...
        Image {
            ...
            Component.onCompleted: setSourceSize(default_img, "Component.onCompleted" )
        }

        Component.onCompleted: setSourceSize(image, "Component.onCompleted")
    }

    function setSourceSize( img, caller ) {
    ...
    Connections {
        ...
        function onDevicePixelRatioChanged() {
            setSourceSize(image, "onDevicePixelRatioChanged");
            setSourceSize(default_img, "onDevicePixelRatioChanged");
        }
    }
