...
Rectangle {
    ...
    property var author: {
        ...
        var a = MessagesAdapter.dataForInteraction(MessagesAdapter.replyToId, MessageList.Author)
        isSelf = a === ""
    ...
    RowLayout {
        ...
        RowLayout {
            ...
            Avatar {
                ...
                imageId: isSelf ? CurrentAccount.id : author
                mode: isSelf ? Avatar.Mode.Account : Avatar.Mode.Contact
            }
