...
ColumnLayout {
    ...
    RowLayout {
        ...
        NewIconButton {
            ...
            iconSource: JamiResources.refresh_24dp_svg
            ...
            RowLayout {
                ...
                NewMaterialButton {
                    ...
                    iconSource: {
                        ...
                        return (sch === "http" || sch === "https") ? JamiResources.link_web_black_24dp_svg : JamiResources.play_circle_outline_24dp_svg;
                    }
                    text: {
                        var sch = serviceRow.modelData.scheme || "";
                ...
                NewMaterialButton {
                    ...
                    implicitHeight: JamiTheme.newMaterialButtonHeight
                    outlinedButton: true
                    iconSource: JamiResources.link_web_black_24dp_svg
