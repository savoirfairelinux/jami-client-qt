 ...
 * tunnel to each one. Designed to be dropped into the contact details
 * dialog (UserProfile.qml).
 */
ColumnLayout {
    id: root
    ...
    Connections {
        ...
        function onPeerServicesReceived(requestId, accountId, peerId, services) {
    ...
    Text {
        ...
        Layout.fillWidth: true
        text: JamiStrings.peerServicesEmpty
