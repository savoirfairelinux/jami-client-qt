...
Window {
    ...
    Page {
        ...
        JamiListView {
            ...
            Keys.onTabPressed: if (activeFocus) selectionBar.forceActiveFocus()
                ...
                RowLayout {
                    ...
                    Label {
                        ...
                        background: Rectangle {
                            ...
                            border.color: fs.activeFocus ? "blue" : "transparent"
                            border.width: 1
                            radius: 5
                        }
                    }
        ...
        header: TabBar {
            ...
            Repeater {
                ...
                TabButton {
                    Accessible.role: Accessible.Button
                    Accessible.name: "shortcuts category"
                    Accessible.description: tabButton.text

                    // on key tab forceActiveFocus
                    Keys.onTabPressed: if (activeFocus) keyboardShortcutsListView.forceActiveFocus()
                    ...
                    background: Rectangle {
                        border.color: tabButton.activeFocus ? "blue" : "transparent"
                        color: {
