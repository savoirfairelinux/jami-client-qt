        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ToggleSwitch {
                    ...
                    // Hide audio toggle on macOS as feature is not yet implemented
                    // Also hide in conferences as it is not supported yet
                    visible: Qt.platform.os.toString() !== "osx" && !CurrentCall.isConference
