    ...
    ColumnLayout {
        ...
        MaterialButton {
            ...
            function errorString(posError) {
                if (posError === "locationClosedError")
                    return JamiStrings.locationClosedError
                if (posError === "locationServiceError")
                    return JamiStrings.locationServiceError
                return "locationUnknownError"
