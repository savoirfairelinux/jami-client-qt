            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    MaterialButton {
                        ...
                        visible: sharePositionButton.visible
                        ...
                        onClicked: {
                            if (!isError && !isUnpin) {
                                if( buttonsChoseSharing.shortSharing)
                                    PositionManager.sharePosition(10 * 60 * 1000, attachedAccountId, currentConvId);
                                else
                                    PositionManager.sharePosition(60 * 60 * 1000, attachedAccountId, currentConvId);
                                //visible = false
                            }
                        }
