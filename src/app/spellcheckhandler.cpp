...
void SpellCheckHandler::dictionariesListPopulated()
{
   connect(spellCheckDictionaryManager_, SIGNAL(void dictionnariesListPopulated()), this, SLOT(onDictionariesListPopulated()));
}
...
void SpellCheckHandler::onDictionariesListPopulated()
{
