...
public:
    ...
    Q_INVOKABLE void stopScanning(/*const QString& accountId, */ const QString& id);
    // Q_INVOKABLE void exportToPeer(const QString& accountId, const QString& uri); // KESS moved to WizardViewStepModel
