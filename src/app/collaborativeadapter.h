...
public:
    ...
    Q_INVOKABLE void setCursor(const QString& convId, const QString& documentId, int position, int anchor);
    ...
    Q_INVOKABLE void applyDelta(const QString& convId, const QString& documentId, const QString& deltaJson);
...
Q_SIGNALS:
    ...
    void cursorChanged(const QString& convId, const QString& documentId, const QString& peerId, int position, int anchor);
