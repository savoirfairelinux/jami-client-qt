...
QtObject {
    ...
    // DEBUG: Prints some info about the current state of the loaded views.
    ...
    function present(viewName, sv=activeStackView, force=false) {
        ...
        // the view specified by the rootViewName property before pushing
        // the requested view to the stack.
