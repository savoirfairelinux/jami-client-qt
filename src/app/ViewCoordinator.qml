...
QtObject {
    ...
    readonly property variant resources: {
        "WelcomeView": "WelcomeView.qml",
        "SmartpanelView": "SmartpanelView.qml",
        "ChatView": "ChatView.qml",
        "CallView": "CallView.qml",
    ...
    readonly property real threshold: 400
