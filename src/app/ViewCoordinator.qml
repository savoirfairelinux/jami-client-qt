...
QtObject {
    ...
    readonly property bool isSinglePaneMode: !isDualPane || currentView.isSinglePane
    ...
    onCurrentViewInfoChanged: Qt.callLater(print, "currentViewInfo changed to " + currentViewInfo)
