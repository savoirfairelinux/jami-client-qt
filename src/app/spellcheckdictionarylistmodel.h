...
Q_SIGNALS:
    ...
    // A generic signal to notify that at least one dictionary is available
    // Used on loading intially or after the pre-load is complete
    void dictionaryAvailable(const QString& localPath);
