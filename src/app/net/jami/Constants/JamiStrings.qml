...
Item {
    ...
    property string confirmRemoveOneToOneConversation: qsTr("Do you want to leave this conversation? The existing history will be deleted. A new conversation may be started if you do not have other conversations with this contact.")
