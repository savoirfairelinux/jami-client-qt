...
Item {
    ...
    property string viewPlugin: qsTr("View extension")
    ...
    property string banned: qsTr("Blocked")
    property string bannedContacts: qsTr("Blocked contacts")
    ...
    property string goBackToPluginsList: qsTr("Go back to extensions list")
    ...
    property string pluginFiles: qsTr("Extension files (*.jpl)")
    ...
    property string choosePlugin: qsTr("Choose extension")
