...
Item {
    ...
    property string languageComboBoxExplanation: qsTr("Select the language for the user interface. The current language selected is %1")
    ...
    property string selectedDescription: qsTr("This is the currently selected %1")
    property string availableOptionDescription: qsTr("This is an available option for %1")
    property string hasBeenSelectedDescription: qsTr("%1 has been selected for %2")
    property string screenSharingFPS: qsTr("Frames per second for screensharing")
    property string screenSharingFPSDescription: qsTr("Select the number of frames per second to be used during screen sharing. The current number of frames per second is '%1")
    property string affectedAudioComponentDescription: qsTr("Select which audio device to use as the %1. The audio device selected for %1 is %2")
    property string audioManagerDescription: qsTr("Select the audio manager to be used. The currently selected audio manager is %1")
}
