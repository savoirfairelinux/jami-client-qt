...
Item {
    ...
    property string scanToImportAccount: qsTr("To continue the import account operation, scan this QR code on the source device.")
    ...
    property string cantScanQRCode: qsTr("If you are unable to scan the QR code, enter the token on the new device.")
    ...
    property string linkDeviceAllSet: qsTr("Import account operation completed successfully.")
    ...
    property string linkDeviceCloseWarningTitle: qsTr("Do you want to cancel the operation?")
    property string linkDeviceCloseWarningMessage: qsTr("Go back and cancel the import account operation.")
