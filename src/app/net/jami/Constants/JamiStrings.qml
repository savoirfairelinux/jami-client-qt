...
Item {
    ...
    property string dictionaryDownloadFailed: qsTr("Dictionary download failed")
    property string downloadDictionarySuccess: qsTr("The dictionary has been downloaded successfully")
