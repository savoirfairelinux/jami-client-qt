...
Item {
    ...
    property string sipResponse415Title: qsTr("Code 415 (Mismatched Codecs)")
    property string sipResponse415Description: qsTr("The call failed because neither of the participants in this call have common codecs enabled. Please agree with the other participant(s) to enable at least one common video codec and at least one common audio codec to proceed with the call. To change your codecs, navigate to: <br><br><b>Settings > Account > Advanced settings > Video Codecs / Audio Codecs.</b>")
