...
Item {
    ...
    property string scanToImportAccount: qsTr("To continue the import account operation, scan this QR code on the new device.")
    ...
    property string updateFound: qsTr("An update for the application is available. Do you want to update the application now? To continue, click Update.")
    ...
    property string linkDeviceAllSet: qsTr("Setup completed successfully.")
