...
Item {
    ...
    property string scanToImportAccount: qsTr("To continue the import account operation, scan the following QR code on the new device.")
    ...
    property string cantScanQRCode: qsTr("If you are unable to scan the QR code, enter the following token on the new device.")
    ...
    property string linkDeviceAllSet: qsTr("Account was imported successfully.")
