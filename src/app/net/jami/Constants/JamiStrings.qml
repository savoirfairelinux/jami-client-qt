...
Item {
    ...
    // Spellchecker
    property string enableSpellCheck: qsTr("Enable spelling correction")
    property string spellCheckLanguage: qsTr("Spelling correction language")
    property string spellCheckavailableLanguages: qsTr("Manage available spelling correction languages")

    //Language
    property string afrikaans: qsTr("afrikaans")
    property string aragonese: qsTr("aragonese")
    property string arabic: qsTr("arabic")
    property string belarusian: qsTr("belarusian")
    property string bulgarian: qsTr("bulgarian")
    property string bengali: qsTr("bengali")
    property string tibetan: qsTr("tibetan")
    property string breton: qsTr("breton")
    property string bosnian: qsTr("bosnian")
    property string catalan: qsTr("catalan")
    property string kurdish_sorani: qsTr("kurdish_sorani")
    property string czech: qsTr("czech")
    property string danish: qsTr("danish")
    property string german: qsTr("german")
    property string greek: qsTr("greek")
    property string english: qsTr("english")
    property string esperanto: qsTr("esperanto")
    property string spanish: qsTr("spanish")
    property string estonian: qsTr("estonian")
    property string persian: qsTr("persian")
    property string french: qsTr("french")
    property string scottish_gaelic: qsTr("scottish_gaelic")
    property string galician: qsTr("galician")
    property string gujarati: qsTr("gujarati")
    property string wayuu: qsTr("wayuu")
    property string hebrew: qsTr("hebrew")
    property string hindi: qsTr("hindi")
    property string croatian: qsTr("croatian")
    property string hungarian: qsTr("hungarian")
    property string indonesian: qsTr("indonesian")
    property string icelandic: qsTr("icelandic")
    property string italian: qsTr("italian")
    property string kurdish_latin: qsTr("kurdish_latin")
    property string korean: qsTr("korean")
    property string lao: qsTr("lao")
    property string lithuanian: qsTr("lithuanian")
    property string latvian: qsTr("latvian")
    property string mongolian: qsTr("mongolian")
    property string nepali: qsTr("nepali")
    property string dutch: qsTr("dutch")
    property string norwegian: qsTr("norwegian")
    property string occitan: qsTr("occitan")
    property string polish: qsTr("polish")
    property string portuguese_brazil: qsTr("portuguese_brazil")
    property string portuguese_portugal: qsTr("portuguese_portugal")
    property string romanian: qsTr("romanian")
    property string russian: qsTr("russian")
    property string sinhala: qsTr("sinhala")
    property string slovak: qsTr("slovak")
    property string slovenian: qsTr("slovenian")
    property string albanian: qsTr("albanian")
    property string serbian: qsTr("serbian")
    property string swedish: qsTr("swedish")
    property string swahili: qsTr("swahili")
    property string telugu: qsTr("telugu")
    property string thai: qsTr("thai")
    property string turkish: qsTr("turkish")
    property string ukrainian: qsTr("ukrainian")
    property string vietnamese: qsTr("vietnamese")
    property string zulu: qsTr("zulu")
}
