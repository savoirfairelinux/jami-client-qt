...
Item {
    ...
    property string confirmRmConversation: qsTr("Do you want to leave this conversation? To continue, click Remove.")
    ...
    property string confirmExtensionReset: qsTr("Do you want to reset the preferences for the %1 extension? To continue, click OK.")
    property string confirmExtensionUninstall: qsTr("Do you want to uninstall the %1 extension? To continue, click OK.")
