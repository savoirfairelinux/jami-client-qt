...
Item {
    ...
    // BannedItemDelegate (aka BlockedItemDelegate)
    ...
    // BannedContacts (aka BlockedContacts)
    ...
    property string extensionsInstallationFailed: qsTr("An error occurred while installing the extension.")
    ...
    property string extensionResetConfirmation: qsTr("Do you really want to reset the preferences for the %1 extension?")
    property string extensionUninstallConfirmation: qsTr("Do you really want to uninstall the %1 extension?")
