...
Item {
    ...
    // ApiTokensPage
    property string apiSettingsTitle: qsTr("App access")
    property string apiSettingsDescription: qsTr("Manage how external applications, bots, or scripts can access this account through the local API.")
    property string apiEnableServer: qsTr("Enable local API server")
    property string apiEnableServerButton: qsTr("Enable server")
    property string apiEnableServerTooltip: qsTr("Start a local HTTP server that external applications can use to interact with Jami")
    property string apiServerSectionTitle: qsTr("Local API server")
    property string apiServerInfoTitle: qsTr("API access is managed per account")
    property string apiServerInfoMessage: qsTr("Configure the local server here, then open App access in the current account settings to create and revoke tokens.")
    property string apiOpenAppAccess: qsTr("Open App access")
    property string apiServerPort: qsTr("Server port")
    property string apiServerRunning: qsTr("Server running on port %1")
    property string apiServerStopped: qsTr("Server stopped")
    property string apiServerDisabledTitle: qsTr("Local API server disabled")
    property string apiServerDisabledMessage: qsTr("The local API server is disabled in application settings. Enable it to generate and manage API tokens for this account.")
    property string apiTokenLabelPlaceholder: qsTr("Token label (e.g. my-bot)")
    property string apiCreateToken: qsTr("Generate token")
    property string apiTokensListTitle: qsTr("Active tokens")
    property string apiNoTokens: qsTr("No API tokens configured for this account.")
    property string apiTokenCreatedAt: qsTr("Created %1")
    property string apiTokenExpiresAt: qsTr("Expires %1")
    ...
    property string exposedServiceTypeLabel: qsTr("Type")
    ...
    property string exposedServiceCustomSchemeLabel: qsTr("URI scheme (optional)")
    ...
    property string exposedServiceDirectory: qsTr("Directory: %1")
    property string exposedServiceDisabled: qsTr("Disabled")
    property string exposedServiceOpenUrl: qsTr("Open %1")
    property string exposedServiceCopyEndpoint: qsTr("Copy %1")
    ...
    property string exposedServiceAddWebsite: qsTr("Add website")
    property string exposedServiceCustomService: qsTr("Custom service")
    property string exposedServiceWhatsThis: qsTr("What's this?")
    property string exposedServiceUriSchemeDetails: qsTr("Enter the URI scheme to use when accessing the service (e.g. http, https, etc…)")
    ...
    property string exposedServiceUnavailable: qsTr("Device unavailable")
    ...
    property string showEditedMessage: qsTr("Show edited")
