...
Item {
    ...
    property string enterJAMSURL: qsTr("Enter the JAMS server URL")
    property string jamiManagementServerURL: qsTr("Jami Account Management Server URL")
    property string jamsCredentials: qsTr("Enter the JAMS server credentials")
    ...
    property string createFromJAMS: qsTr("Create account from JAMS")
