...
Item {
    ...
    property string cantScanQRCode: qsTr("If the QR code is unable to be scanned, enter the token on the new device.")
    ...
    property string linkDeviceCloseWarningTitle: qsTr("Click here to go back")
