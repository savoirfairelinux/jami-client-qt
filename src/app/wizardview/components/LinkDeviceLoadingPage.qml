...
Rectangle {
    ...
    Connections {
        ...
        //     print("[LinkDevice] LinkDeviceLoadingPage page: onLinkStateChanged")
        //     switch (linkOption) {
        //     case WizardViewStepModel.LinkDeviceStep.Waiting:
        //         print("[LinkDevice] LinkDeviceLoadingPage page: onLinkStateChanged Waiting")
        //         root.showThisPage()
        //         // WizardViewStepModel.linkDeviceStep = WizardViewStepModel.linkDeviceStep.Waiting
        //         // AccountAdapter.createJamiAccount(WizardViewStepModel.accountCreationInfo)
        //         break
        //     default:
        //         // print("[LinkDevice] LinkDeviceLoadingPage page: onLinkStateChanged default")
    ...
    Connections {
        ...
        function onDeviceAuthStateChanged(accountId, state, detail) {
            if (state != 0) {
                console.warn("[LinkDevice] LinkDeviceLoadingPage state: ", detail)
            }
        }
    }
    ...
    ColumnLayout {
        ...
        // title
        Text {
            text: "LinkDeviceLoadingPage: Link Device Spinner Page"//JamiStrings.importAccountFromAnotherDevice
        ...
        // TODO add spinner or jami movie logo
