...
Rectangle {
    ...
    // can be used to debug the qr code renderer on this page
    // function dummyQr() {
    ...
    ColumnLayout {
        ...
        MaterialButton {
            ...
            text: "debug wz -> wait"
            visible: false // TODO make debugBtns visible only when in testing mode OR just remove them all when done
            onClicked: {
        ...
        MaterialButton {
            ...
            Layout.preferredWidth: Math.min(100 + 2*Jamitheme.buttontextWizzardPadding, root.width - JamiTheme.preferredMarginSize * 2) // TODO Fix this sizing
