...
Rectangle {
    ...
    property int preferredHeight: customizeProfileStack.implicitHeight
    property string alias: ""
    property string imageId: LRCInstance.currentAccountId

    signal showThisPage

    /*function initializeOnShowUp(isRdv) {
        customizeProfileStack.currentIndex = 0;
        clearAllTextFields();
    }*/
    ...
    Connections {
        ...
        function onMainStepChanged() {
            ...
            if (currentMainStep === WizardViewStepModel.MainSteps.ProfileCustomization) {
                customizeProfileStack.currentIndex = customizeProfilePage.stackIndex;
                root.showThisPage();
            }
        }
    }
    ...
    StackLayout {
        id: customizeProfileStack
        Layout.minimumHeight: 1000
        objectName: "customizeProfileStack"
        anchors.fill: parent
            ...
            ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                ...
                                PhotoboothView {
                                    ...
                                    visible: true
                                    //visible: UtilsAdapter.tempCreationImage(root.imageId).length !== 0
                                }
                                    ...
                                    onClicked: {
                                        ...
                                        dlg.onImageValidated.connect(function () {
                                                if (UtilsAdapter.tempCreationImage(LRCInstance.currentAccountId).length !== 0) {
                                                    ...
                                                    console.warn("onImageValidated.connect");
                                                }
                                            });
                                        dlg.onImageRemoved.connect(function () {
                                                if (UtilsAdapter.tempCreationImage(LRCInstance.currentAccountId).length !== 0) {
                                                    accountAvatar.visible = true;
                                                    console.warn("onImageRemoved.connect");
                                                }
                                            });
                                    }
                                }
                ...
                RowLayout {
                    ...
                    MaterialButton {
                        ...
                        Layout.alignment: Qt.AlignCenter
                        Layout.topMargin: 1/2 * JamiTheme.wizardViewBlocMarginSize

                        text: JamiStrings.skip
                        toolTipText: JamiStrings.skipProfile

                        KeyNavigation.tab: backButton
                        KeyNavigation.up: finishStartupButton
                        KeyNavigation.down: backButton
