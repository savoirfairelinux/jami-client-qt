            ...
            ColumnLayout {
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        layer.enabled: true
                        color: root.icon1Hovered ? JamiTheme.buttonTintedBlueHovered : JamiTheme.secAndTertiHoveredBackgroundColor
                        anchors.fill: parent
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        layer.enabled: true
                        color: root.icon2Hovered ? JamiTheme.buttonTintedBlueHovered : JamiTheme.secAndTertiHoveredBackgroundColor
                        anchors.fill: parent
