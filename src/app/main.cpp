...
#if WITH_WEBENGINE
    const auto webEngineRuntimeAvailable = Utils::isWebEngineRuntimeAvailable();
...
#if WITH_WEBENGINE
    app.setProperty(Utils::WebEngineRuntimeAvailableProperty, webEngineRuntimeAvailable);
#endif
