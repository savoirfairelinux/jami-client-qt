...
ListSelectionView {
    ...
    property variant resources: {
        ...
        "ConversationCallSettingsPage": Qt.resolvedUrl("components/ConversationCallSettingsPage.qml"),
    ...
    rightPaneItem: StackView {
        ...
        onCurrentIndexChanged: {
            ...
            case 8:
                ...
                break;
            case 9:
                replace(currentItem, viewNode.resources["ConversationCallSettingsPage"], StackView.Immediate);
                break;
            case 10:
