        ...
        ListView {
            ...
            delegate: ColumnLayout {
                ...
                PushButton {
                    ...
                    buttonTextFont.pixelSize: isChildSelected ? JamiTheme.settingsDescriptionPixelSize : JamiTheme.settingMenuPixelSize
                    ...
                    onClicked: selectChild(modelData.first)
                ...
                ListView {
                    ...
                    delegate: ColumnLayout {
                        ...
                        PushButton {
                            ...
                            alignement: Text.AlignLeft
                            Layout.preferredWidth: root.width - 28
                            ...
                            buttonTextFont.pixelSize: isSelected ? JamiTheme.settingsDescriptionPixelSize : JamiTheme.settingMenuPixelSize
                            ...
                            onClicked: selectChild(modelData.id)
