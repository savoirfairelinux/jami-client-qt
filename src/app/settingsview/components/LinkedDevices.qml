...
ColumnLayout {
    ...
    JamiListView {
        ...
        Layout.topMargin: otherDevicesTitle.visible ? JamiTheme.settingsCategorySpacing : 0
        spacing: settingsListViewsSpacing
        interactive: false
    ...
    MaterialButton {
        ...
        Layout.alignment: Qt.AlignLeft
        Layout.topMargin: JamiTheme.settingsCategorySpacing
