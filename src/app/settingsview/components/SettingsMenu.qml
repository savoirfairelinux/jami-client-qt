...
Rectangle {
    ...
    ColumnLayout {
        ...
        SMB {
            buttonText: JamiStrings.appearence
        }

        SMB {
            buttonText: JamiStrings.locationSharingLabel
        }
        SMB {
            buttonText: JamiStrings.fileTransfer
        }
        SMB {
            buttonText: JamiStrings.callRecording
        }
