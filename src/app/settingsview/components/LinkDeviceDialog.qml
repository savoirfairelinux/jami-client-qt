...
BaseModalDialog {
    ...
    function canCloseDirectly() {
        return DeviceLinkingModel.deviceAuthState === DeviceAuthStateEnum.INIT ||
               DeviceLinkingModel.deviceAuthState === DeviceAuthStateEnum.DONE ||
               DeviceLinkingModel.deviceAuthState === DeviceAuthStateEnum.ERROR
    }
