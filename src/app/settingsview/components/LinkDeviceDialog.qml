...
BaseModalDialog {
        ...
        ScrollView {
           ...
           // anchors.topMargin: controls.height + 10
            ...
            StackLayout {
                ...
                currentIndex: linkDeviceItem.StackLayout.index  // Default to linkDeviceItem
    ...
    Connections {
        ...
        function onDeviceAuthStateChanged() {
            ...
            case DeviceLinkingModel.Init:
                stackLayout.currentItem = linkDeviceItem
                break
            case DeviceLinkingModel.Connecting:
                stackLayout.currentItem = loadingIndicator
                break
            case DeviceLinkingModel.Authenticating:
                stackLayout.currentItem = connectItem
                break
            case DeviceLinkingModel.InProgress:
                stackLayout.currentItem = loadingIndicator
                break
            case DeviceLinkingModel.Done:
                stackLayout.currentItem = successView
                root.close()
                break
            case DeviceLinkingModel.Error:
                stackLayout.currentItem = errorView
                break
            }
        }
    }
