...
BaseModalDialog {
    ...
    title: "Authentication Required" //JamiStrings.authenticationRequired

    closeButtonVisible: false

    button1.text: "proceed" //JamiStrings.optionRemove
    button1Role: DialogButtonBox.DestructiveRole
    button1.enabled: false
    button1.onClicked: {
        AccountAdapter.provideAccountAuthentication(CurrentAccount.id, pwd)
        // TODO only close if password correct!
        close()
    }
