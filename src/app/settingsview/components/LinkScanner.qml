...
BaseModalDialog {
    ...
    ColumnLayout {
        ...
        // KESS TODO
        // show video preview
        // small collapsible menu that contains all the combo boxes
        ...
        function startPreviewing(force = false) {
            ...
            LinkDeviceModule.startScanning(VideoDevices.getDefaultDevice());
            linkDeviceModule.startScanning(VideoDevices.getDefaultDevice());
        ...
        Rectangle {
            ...
            LocalVideo {
                ...
                //     function onFrameUpdated () {// frameUpdated
