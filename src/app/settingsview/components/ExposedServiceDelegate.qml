...
ItemDelegate {
        ...
        RowLayout {
            ...
            Column {
                ...
                Row {
                    ...
                    Text {
                        width: Math.min(implicitWidth, parent.width - policyTag.implicitWidth - parent.spacing)
                        text: modelData.name
                        color: JamiTheme.textColor
            ...
            NewIconButton {
                ...
                onClicked: {
                    viewCoordinator.presentDialog(appWindow, "settingsview/components/ExposedServiceDialog.qml", {
                                                      ...
                                                      "serviceScheme": modelData.serviceType === "embedded" ? "http" : modelData.scheme,
    ...
    background: Rectangle {
        radius: height / 2
        color: root.isHovered || root.highlighted ? JamiTheme.smartListSelectedColor : JamiTheme.editBackgroundColor
    }
}