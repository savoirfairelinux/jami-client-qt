    ...
    flickableContent: ColumnLayout {
        ...
        Column {
            ...
            ToggleSwitch {
                ...
                checked: new Date(Date.parse(new Date(2998, 1, 1, 0, 0, 0, 0).toISOString().slice(0, 16).replace("T", " "))) >= new Date(Date.parse(UtilsAdapter.getAppValue(Settings.Key.DonateDateBis)))
