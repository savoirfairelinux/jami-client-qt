    ...
    flickableContent: ColumnLayout {
        ...
        Column {
            ...
            ToggleSwitch {
                ...
                onSwitchToggled: {
                    JamiQmlUtils.setDonationToggleChecked();
                }
            }
        ...
        MaterialButton {
            ...
            onClicked: {
                ...
                enableDonation.checked = Qt.binding(() => JamiQmlUtils.isDonationToggleChecked());
                UtilsAdapter.setToDefault(Settings.Key.DonateVisibleDate);
                enableDonation.checked = Qt.binding(() => JamiQmlUtils.isDonationToggleChecked());
            }
        }
    }
