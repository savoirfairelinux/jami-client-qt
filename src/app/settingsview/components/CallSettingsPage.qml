...
SettingsPageBase {
    ...
    flickableContent: ColumnLayout {
        ...
        ColumnLayout {
            ...
            ToggleSwitch {
                id: checkBoxDenySecondCalls

                labelText: JamiStrings.denySecondCalls
                checked: CurrentAccount.denySecondCalls
                onSwitchToggled: CurrentAccount.denySecondCalls = checked
            }
        }
