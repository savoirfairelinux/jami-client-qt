...
BaseModalDialog {
        ...
        Loader {
            ...
            sourceComponent: ColumnLayout {
                ...
                NewMaterialTextField {
                    ...
                    placeholderText: "Bot Name (as seen by others)"

                    onAccepted: {
                        root.botDisplayName = modifiedTextFieldContent
                    }
                }
            }
        }
        ...
        Loader {
            ...
            sourceComponent: ColumnLayout {
                ...
                Text {
                    ...
                    color: JamiTheme.textColor
                    text: "This is the only time you will see the token. Take note of it somewhere!"
                }
    ...
    button1.onClicked: {
        ...
        case CreateBotDialog.Stage.ChooseDisplayName:
            ...
            const botOwnerId = CurrentAccount.uri
    ...
    Connections {
        ...
        function onAccountAdded(accountId, index) {
            if (root.currentStage !== CreateBotDialog.Stage.ChooseDisplayName || root.pendingTokenLabel.length === 0)
                return;
