        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Slider {
                    ...
                    value: Number(AccountSettingsManager.accountSettingsPropertyMap.backgroundBlur !== undefined ? AccountSettingsManager.accountSettingsPropertyMap.backgroundBlur : 32)
