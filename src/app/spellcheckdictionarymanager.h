...
private:
// This is hardcoded because we don't want to send request including user metadata to microsoft everytime a user boots Jami
// This should regularly be updated from the libreOffice github repository
// https://api.github.com/repos/LibreOffice/dictionaries/git/trees/master?recursive=1
