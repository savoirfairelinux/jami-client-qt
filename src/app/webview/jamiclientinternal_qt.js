...
(function (_JamiClientInternal) {
    _JamiClientInternal.MESSAGE_ID_NO_RESPONSE = "";

    class JamiClient extends EventTarget {
        ...
        constructor() {
            ...
            new QWebChannel(qt.webChannelTransport, (channel) => {
                ...
                this.sharedObj.jsMessage.connect((message, messageId) => {
                    ...
                    const event = new CustomEvent(JamiClient.eventName, {
                        detail: {
                            message: message,
                            messageId: messageId,
                        },
        ...
        static getInstance() {
            if (!JamiClient.instance) {
                JamiClient.instance = new JamiClient();
            }
            return JamiClient.instance;
        }
    ...
    JamiClient.eventName = "jami_client_message";
    _JamiClientInternal.JamiClient = JamiClient;
