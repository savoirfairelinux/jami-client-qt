...
WebEngineView {
    ...
    QtObject {
        ...
        function requestAccountName() {
            console.error("qml responding with account name");
            return CurrentAccount.registeredName ? CurrentAccount.registeredName : CurrentAccount.uri
        }

        function requestFilePath(mode, id) {
            var response = ""
