...
WebEngineView {
    ...
    QtObject {
        ...
        function sendMessage(payload, messageId) {
            console.debug("qml sending webview message");
    ...
    Component.onCompleted: function() {
        ...
        webEngineView.runJavaScript("console.debug('web engine js ready');");
    ...
    Connections {
        ...
        function onWebViewMessageReceived(pluginId, webViewId, messageId, payload) {
            ...
            console.debug(
                `WebView #${webEngineView.webViewId} sees message from plugin:` +
            ...
            if (pluginId != webEngineView.pluginId || webViewId != webEngineView.webViewId) {
                return;
            }
