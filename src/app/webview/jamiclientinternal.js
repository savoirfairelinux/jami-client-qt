...
(function (_JamiClientInternal) {
    ...
    class _JamiClient extends EventTarget {
        ...
        requestFilePath(mode, messageId) {
            console.error("_JamiClientInternal.JamiClient received request for file path");
            // call the function inside the qml object (which then calls the adapter function)
            this.#sharedObj.requestFilePath(mode, messageId);
        }
    }
