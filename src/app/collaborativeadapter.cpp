    ...
    : QmlAdapterBase(instance, parent)
{
    ...
    connect(&ConfigurationManager::instance(),
            ...
            [this](const QString& accountId,
                   ...
                   int position,
                   int anchor) { Q_EMIT cursorChanged(accountId, convId, documentId, peerId, position, anchor); });
    connect(&ConfigurationManager::instance(),
...
CollaborativeAdapter::openDocument(const QString& accountId, const QString& convId, const QString& documentId)
{
    ...
    return ConfigurationManager::instance().openCollaborativeDocument(accountId, convId, documentId);
}
...
CollaborativeAdapter::edit(const QString& accountId,
                           ...
                           const QString& insert)
{
    ConfigurationManager::instance().editCollaborativeDocument(accountId, convId, documentId, index, deleteLen, insert);
}
...
{
    ConfigurationManager::instance().setCollaborativeCursor(accountId, convId, documentId, position, anchor);
}
...
{
    return ConfigurationManager::instance().collaborativeDocumentContentDelta(accountId, convId, documentId);
}
...
{
    return ConfigurationManager::instance().collaborativeDocumentTextAt(accountId, convId, documentId, commitId);
}
...
CollaborativeAdapter::restore(const QString& accountId,
                              ...
                              const QString& commitId)
{
    return ConfigurationManager::instance().restoreCollaborativeDocument(accountId, convId, documentId, commitId);
}
