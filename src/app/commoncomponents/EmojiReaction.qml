...
Popup {
    ...
    width: emojiColumn.width + 20
    height: emojiColumn.height + 20
    padding: 0
            ...
            RowLayout {
                ...
                Repeater {
                    ...
                    delegate:Button {
                        ...
                        text: modelData
                        font.pointSize: curButton.hovered
                        ...
                        background: Rectangle {
                            ...
                            color: JamiTheme.emojiReactButtonBgColor
                            radius: 10
                        }
                ...
                PushButton {
                    ...
                    imageColor: JamiTheme.timestampColor
