...
Popup {
    ...
    property alias button1Text: action1.text
    property alias button2Text: action2.text
    property var popupcontainerSubContentLoader: containerSubContentLoader
    property bool closeButtonVisible: true
    property variant button1Clicked: action1.onClicked
    property variant functionAction2: action2.onClicked
    ...
    contentItem: Control {
        ...
        contentItem: ColumnLayout {
            ...
            Loader {
                ...
                Layout.bottomMargin: buttonsLayout.visible ? 20 : 0
                Layout.rightMargin: popupMargins
            ...
            RowLayout {
                id: buttonsLayout
                visible: action1.visible || action2.visible
