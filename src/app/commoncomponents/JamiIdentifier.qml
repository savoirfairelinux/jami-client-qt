...
Item {
    ...
    RowLayout {
        ...
        RoundedBorderRectangle {
            ...
            RowLayout {
                ...
                ResponsiveImage {
                    ...
                    containerHeight: 40
                    containerWidth: 40
                    Layout.leftMargin: JamiTheme.pushButtonMargin
        ...
        RoundedBorderRectangle {
            id: rightRect
            fillColor: jamiId.backgroundColor
            Layout.preferredWidth: childrenRect.width + 2 * JamiTheme.pushButtonMargin
            ...
            RowLayout {
                ...
                anchors.leftMargin: JamiTheme.pushButtonMargin
