        ...
        RowLayout {
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onExited: {
                        contextMenuItemImage.color = JamiTheme.primaryBackgroundColor;
                    }
                    onClicked: {
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onExited: {
                        contextMenuItemImage2.color = JamiTheme.primaryBackgroundColor;
                    }
                    onClicked: {
            ...
            Rectangle {
                ...
                MouseArea {
                    ...
                    onExited: {
                        contextMenuItemImage3.color = JamiTheme.primaryBackgroundColor;
                    }
                    onClicked: {
