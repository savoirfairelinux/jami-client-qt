            ...
            RowLayout {
                ...
                Item {
                    ...
                    MaterialButton {
                        ...
                        KeyNavigation.tab: {
                            try {
                                if (model.index < dictionaryProxyModel.count - 1) {
                                    ...
                                    if (nextItem) {
                                        var nextButton = nextItem.findChild("installButton") ||
                                                       nextItem.findChild("uninstallButton")
                        ...
                        onFocusChanged: {
                            if (focus) {
                                spellCheckDictionaryListView.positionViewAtIndex(
                                    model.index,
                                    ListView.Contain
                                )
                            }
            ...
            ColumnLayout {
                ...
                Text {
                    ...
                    text: dictionarySearchBar.textContent.length > 0 ?
                            JamiStrings.noDictionariesFoundFor.arg(dictionarySearchBar.textContent) :
                            JamiStrings.noDictionariesAvailable
                    color: JamiTheme.faddedLastInteractionFontColor
                    font.pixelSize: JamiTheme.settingsDescriptionPixelSize
