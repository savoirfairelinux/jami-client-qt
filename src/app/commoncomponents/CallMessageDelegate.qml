...
SBSMessageBase {
    ...
    property bool isActive: {
        // Reference activeCalls to make this binding reactive
        CurrentConversation.activeCalls;
        // Now check if THIS specific call is in the active calls list
        return LRCInstance.indexOfActiveCall(root.confId, ActionUri, DeviceId) !== -1;
    }
