...
ColumnLayout {
    ...
    // placeholderText is the text that will be shown when textFieldContent and modifiedTextFieldContent are empty
    // (ex: "Add description" SwarmDetailsPanel (swarm only))
    property string placeholderText: ""
    // textFieldContent is the text that is shown in the text field, it essentially acts as a default/prefill
    // (ex: The actual description of the swarm)
    property string textFieldContent: ""
    // modifiedTextFieldContent is the text that represents the modified version of the textFieldContent
    // (ex: The modified description of the swarm prior to calling the accepted signal)
    property string modifiedTextFieldContent
    property int maxCharacters: -1
    property bool readOnly: false
    property string textFieldFontFamily: JamiTheme.ubuntuFontFamily
    ...
    opacity: textField.activeFocus && !root.readOnly ? 1.0 : 0.7
    ...
    Control {
        ...
        contentItem: RowLayout {
            ...
            Button {
                ...
                icon.width: JamiTheme.iconButtonMedium
                icon.height: JamiTheme.iconButtonMedium
                icon.source: root.trailingIconSource
                icon.color: {
                    if (pressed) {
                        return JamiTheme.textColor;
                    } else if (hovered) {
                        return JamiTheme.newMaterialTextFieldTrailingIconHoveredColor;
                    } else {
                        return JamiTheme.newMaterialTextFieldTrailingIconColor;
                    }
                }
                ...
                MaterialToolTip {
                    ...
                    text: root.trailingIconToolTipText

                    visible: (trailingIcon.hovered || trailingIcon.activeFocus) && (toolTipText.length > 0)
        ...
        background: Rectangle {
            ...
            border.width: 1
            border.color: textField.activeFocus && !root.readOnly ? root.borderColor : JamiTheme.transparentColor
        ...
        MaterialToolTip {
            ...
            parent: parent
            visible: parent.hovered && root.toolTipText !== "" && !root.readOnly && !trailingIcon.hovered
            delay: Qt.styleHints.mousePressAndHoldInterval
        }
    }
}
