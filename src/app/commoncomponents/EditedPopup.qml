...
BaseModalDialog {
    ...
    property var oldbodies: undefined
        ...
        JamiListView {
            ...
            delegate: Rectangle {
                ...
                RowLayout {
                    ...
                    Text {
                        // TODO modelData[2] => timestamp (change QStringList by struct)
                        Layout.preferredWidth: root.width / 4
                        Layout.leftMargin: JamiTheme.settingsMarginSize

                        text: MessagesAdapter.getFormattedDay(modelData[2]) + " - " + MessagesAdapter.getFormattedTime(modelData[2])
