...
BaseModalDialog {
    ...
    property string errorTitle: JamiStrings.sipError
    ...
    function showSIPCallStatusError(errorCode) {
        ...
        case 415: // Unsupported Media Type
            errorReason = JamiStrings.sipError415Title.arg(errorCode);
            errorDescription = JamiStrings.sipError415Description;
            break;
        default:
            errorReason = JamiStrings.sipErrorCode.arg(errorCode);
            errorDescription = JamiStrings.sipErrorMessage.arg(errorCode);
            break;
        }
        open();
    }
