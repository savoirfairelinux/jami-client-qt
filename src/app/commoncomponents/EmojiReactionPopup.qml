    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Layout.alignment: Qt.AlignCenter
//                height: listViewReaction.implicitHeight
//                width: listViewReaction.width

                ListView {
                    id: listViewReaction

                    Layout.preferredWidth: 400
                    Layout.preferredHeight: modelCount < 5 ? 50 + (JamiTheme.avatarSize * modelCount) : 300
                    model: Object.entries(emojiReaction)
                    clip: true
                    property int modelCount: Object.entries(emojiReaction).length
                    onModelCountChanged: {
                        console.warn(modelCount)
                    }
                    onHeightChanged: {
                        console.warn(height)
                    }
