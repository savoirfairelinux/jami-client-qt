...
ApplicationWindow {
    ...
    QtObject {
        ...
        readonly property real left: {
            if (useFrameless && Qt.platform.os.toString() === "osx" && viewCoordinator.isInSinglePaneMode)
                return 80;
            return 0;
        }
        // Windows and Linux buttons are on the right.
        readonly property real right: useFrameless ? systemButtonGroupLoader.width + 24 : 0
    }
