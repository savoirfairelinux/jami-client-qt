...
ApplicationWindow {
    ...
    Button {
        ...
        // To debug RTL:
        // - use QML_PROPERTY(bool, isRTL) instead of QML_RO_PROPERTY(bool, isRTL) in UtilsAdapter
    ...
    visibility:
        (mainViewLoader.status === Loader.Ready && windowSettingsLoaded && allowVisibleWindow)
            ? visibility
            : Window.Hidden
