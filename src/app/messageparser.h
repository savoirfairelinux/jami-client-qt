...
private:
    // Preprocess the message (e.g. handle line breaks). The message is expected
    ...
    // Get the first link in html the message. Use a QVariant to return a null
    // value if no link is found.
    QVariant getFirstLink(const QString& html);
