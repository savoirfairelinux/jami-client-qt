...
#ifndef ACCOUNTSETTINGSMANAGER_H
#define ACCOUNTSETTINGSMANAGER_H
...
{
    Q_OBJECT
    Q_PROPERTY(AccountSettingsPropertyMap* accountSettingsPropertyMap READ
                   accountSettingsPropertyMap CONSTANT)
public:
...
#endif // ACCOUNTSETTINGSMANAGER_H
