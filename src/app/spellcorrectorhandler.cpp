...
SpellCorrectorHandler::availableDictionaries(){
    ...
    if (reply->error() == QNetworkReply::NoError) {
        ...
        QRegExp regexWithCountry("'>[a-z]{2,3}_[A-Z]{2}</a></li>");  // matches patterns like af_ZA
        ...
        while ((pos = regexWithCountry.indexIn(htmlContent, pos)) != -1) {
            ...
            if (!foundDictionaries.contains(match)) {
                ...
                qWarning() << "Found dictionary with country:" << match << "Native name:" << nativeName;
            }
        ...
        while ((pos = regexSimple.indexIn(htmlContent, pos)) != -1) {
            ...
            if (!foundDictionaries.contains(match)) {
                ...
                qWarning() << "Found simple dictionary:" << match << "Native name:" << nativeName;
            }
