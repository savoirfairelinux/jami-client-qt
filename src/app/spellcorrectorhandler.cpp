...
SpellCorrectorHandler::installedDictionaries()
{
    if (cachedinstalledDictionaries.size() > 0) {
        qWarning() << "Returning cached installed dictionaries, dictionnaries size : "+ QString::number(cachedinstalledDictionaries.size());
...
void SpellCorrectorHandler::refreshDictionaries(){
