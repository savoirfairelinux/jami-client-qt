...
Item {
    ...
    property string locationServiceError: qsTr("Positioning failed: The application lacked the required privileges. Try to turn on localisation services on your computer.")
    property string locationClosedError: qsTr("Positioning error: The connection was close. As soon as the location service is re-enabled, regular updates will resume.")
    property string failedPositioning: qsTr("Positioning error: unknown error ")
