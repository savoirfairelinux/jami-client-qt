...
Item {
    ...
    property string createRV: qsTr("Create a rendez-vous point")
    ...
    property string importAccountFromOtherDevice: qsTr("Import from an other device")
    ...
    property string createNewRV: qsTr("Create a rendez-vous point")
    ...
    property string introductionJami: qsTr("Share, freely and privately\n with Jami")
