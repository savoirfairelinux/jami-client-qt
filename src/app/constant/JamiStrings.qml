...
Item {
    ...
    property string currentKey: qsTr("Current key:")
    property string changeKey: qsTr("Change key")

    //ChangePttKeyPopup
    property string assignmentIndication: qsTr("Press the key you want to assign to push to talk.")
