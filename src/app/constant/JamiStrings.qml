...
Item {
    ...
    property string certificateFile: qsTr("Certificate File")
    property string audioFile: qsTr("Audio File")
    ...
    property string keyFile: qsTr("Key File")
    ...
    property string imageFiles: qsTr("Image Files")
    ...
    property string screen: qsTr("Screen")
