...
Item {
    ...
    property string locationServiceError: qsTr("Location error: Jami needs to access to your location. Please turn on Location Services in your device settings. Other participants' position can still be received.")
    ...
    property string locationUnknownError: qsTr("Location error: Unknown error occurred. Other participants' location can still be received.")
