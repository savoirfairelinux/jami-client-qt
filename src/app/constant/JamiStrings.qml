...
Item {
    ...
    property string passwordArchive: qsTr("If your account is encrypted with a password, please fill the following field.")
    ...
    property string importPasswordDesc: qsTr("Fill if your account is password-encrypted.")
