...
Item {
    ...
    property string screenshotParticipant: qsTr("Take tile screenshot")
    property string screenshotTaken: qsTr("Screenshot of %1 tile")
    ...
    property string saveIn: qsTr("Save recordings to")
    property string saveScreenshotIn: qsTr("Save screenshots to")
