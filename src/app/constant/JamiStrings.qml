...
Item {
    ...
    property string jamsDecription: qsTr("Enter the URL of the JAMS account management server")
    ...
    property string jamsReferences: qsTr("Enter you JAMS references")
    ...
    property string personalizeAccount: qsTr("Personalize your account")
    property string addSip: qsTr("Add my SIP")
    ...
    property string encryptAccount: qsTr("Encrypt account with a password")
    property string customizeProfile: qsTr("Customize your profile")
    ...
    property string importFromArchiveBackup: qsTr("Import from an archive backup")
    ...
    property string selectArchiveFile: qsTr("Select an archive file")
    ...
    property string importFromDeviceDescription: qsTr("To use an existing Jami model on this device, you need to obtain a NIP (define NIP) code.")
    ...
    property string importStep2Desc: qsTr("Choose the Jami account to use")
    property string importStep3Desc: qsTr("Select “Use this account to an other device”")
    property string importStep4Desc: qsTr("The NIP code will be avalable for 10 minutes.")
    ...
    property string identifierDescription: qsTr("Here is your Jami identifier, don’t hesitate to share it in order to be contacted more easily!")
