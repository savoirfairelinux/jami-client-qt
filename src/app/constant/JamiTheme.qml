...
Item {
    ...
    Connections {
        ...
        function onChangeFontSize() {
            baseOffset = UtilsAdapter.getAppValue(Settings.BaseOffset)
        }
    }
    ...
    function calcSize(size) {
        return Math.min(Math.max(3, size), 30)
    }

    property real baseOffset: UtilsAdapter.getAppValue(Settings.BaseOffset)
    property real fontSizeOffset: baseOffset + (Qt.platform.os.toString() === "osx" ? 3 : 0)
    property real fontSizeOffsetSmall: baseOffset + (Qt.platform.os.toString() === "osx" ? 1 : 0)
    ...
    property real chatviewFontSize: calcSize(15 + baseOffset)
    ...
    property real indicatorFontSize: calcSize(6 + baseOffset)
    property real tinyFontSize: calcSize(7 + fontSizeOffset)
    property real textFontSize: calcSize(9 + fontSizeOffset)
    property real bigFontSize: calcSize(22 + baseOffset)
    property real settingsFontSize: calcSize(11 + fontSizeOffset)
    property real buttonFontSize: calcSize(9 + baseOffset)
    property real participantFontSize: calcSize(10 + baseOffset)
    ...
    property real primaryRadius: calcSize(4 + baseOffset)
    ...
    property real filterBadgeFontSize: calcSize(8.25 + baseOffset)
    ...
    property int participantCallInNameFontSize: calcSize(11 + baseOffset)
    property int participantCallInStatusFontSize: calcSize(8 + baseOffset)
    ...
    property real usernameBlockFontSize : calcSize(12 + baseOffset)
