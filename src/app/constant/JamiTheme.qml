...
Item {
    ...
    property color secondaryButtonBorderColor: darkTheme ? "#03B9E9" : "#e3eef6"
    ...
    property color switchBackgroundColor: darkTheme ? "#626262" : "#E3EEF6"
    ...
    property color comboboxBackgroundColorHovered: darkTheme ? "#123F4A" : "#E3EEF6"
    ...
    property real welcomeLogoWidth: 150
    property real welcomeLogoHeight: 150
