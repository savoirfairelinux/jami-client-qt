...
def deploy_runtimes(qt_dir, skip_qt_deploy=False):
    ...
    if os.path.exists(stamp_file) or skip_qt_deploy:
        return
...
def parse_args():
    ...
    parser.add_argument(
        ...
        action='store_true',
        default=False,
        help='Force skip deployment of qt runtime files')
    parser.add_argument(
        "-sb",
        "--skip-build",
        action="store_true",
...
def main():
    ...
    def do_build(do_tests):
        ...
        deploy_runtimes(parsed_args.qt, parsed_args.skip_qt_deploy)
