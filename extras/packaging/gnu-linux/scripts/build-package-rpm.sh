...
cp patches/*.patch /root/rpmbuild/SOURCES/ || true
...
QT_TARBALL_SHA256="cbc81e726b0ff3c0cdb0219bf74545e91cec013c4a8503c20f93f83d73dff5d2"
...
if [ ! -f "${RPM_PATH}" ]; then
    ...
    (
        ...
        elif [[ "${DISTRIBUTION}" == "fedora_44" ]]; then
            cp /root/rpmbuild/RPMS/x86_64/jami-libqt-$QT_MAJOR_MINOR_PATCH-*.fc44.x86_64.rpm "${RPM_PATH}"
