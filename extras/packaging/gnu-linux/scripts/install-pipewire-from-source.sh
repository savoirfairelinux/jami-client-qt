...
# Get a version of Meson that's recent enough to build PipeWire 1.0.5
...
cd pipewire-1.0.5
python3 ../meson-0.61.1/meson.py setup builddir -Dsession-managers=media-session -Dalsa=disabled -Dprefix=/usr/local
