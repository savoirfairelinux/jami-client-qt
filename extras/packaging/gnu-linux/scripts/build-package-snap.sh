...
cp -r /opt/client-qt/extras/packaging/gnu-linux/packaging/rules/snap/common .
cp -r /opt/client-qt/extras/packaging/gnu-linux/packaging/rules/snap/${SNAP_PKG_NAME}/snapcraft.yaml .
