...
${QT_MAJOR}.${QT_MINOR}/${qt_version}/single
        ...
        tar xf "/src/$RELEASE_TARBALL_FILENAME" client-qt/extras/packaging/gnu-linux/packaging/rules/debian-qt \
            --strip-components=6 && mv debian-qt debian
...
cp debian/changelog extras/packaging/gnu-linux/packaging/rules/debian
rm -r debian
ln -s extras/packaging/gnu-linux/packaging/rules/debian .
