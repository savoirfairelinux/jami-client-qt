...
macro(create_libjami_headers_target)
  add_library(libjami_headers INTERFACE)
  target_link_libraries(libjami_headers INTERFACE LibJami::LibJami)
  add_library(LibJami::Headers ALIAS libjami_headers)
endmacro()

if(WITH_DAEMON_SUBMODULE)
  if(JAMICORE_AS_SUBDIR)
    add_library(LibJami::LibJami ALIAS jami-core)
    create_libjami_headers_target()
