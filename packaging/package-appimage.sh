...
LD_LIBRARY_PATH=/usr/lib/:/usr/lib64/:/usr/lib64/pulseaudio:/usr/lib64/qt5/libexec:/usr/lib/qt/plugins/platforms/:$(pwd)/../install/daemon/lib:$(pwd)/../install/lrc/lib $full_path \
