...
Remember to specify the ubuntu version you're using.
...
Remember to specify the Debian version you're using.
...
Remember to specify the Fedora version you're using.
...
If you're a developper you need to install clang-format separatly before initilizing with the command ```sudo apt install clang-format```
